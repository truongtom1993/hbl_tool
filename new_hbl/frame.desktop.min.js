...
!function() {
	...
	function checkType(t) {
		// kiểm tra điều kiện rồi set lại chính function checkType thành cái khác
			return checkType = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
					return typeof e
			}
			: function(e) {
	...
	function t(t, n) {
			for (var r = 0; r < n.length; r++) {
					...
					Object.defineProperty(t, (o = i.key,
					a = void 0,
					a = function(t, n) {
							if ("object" !== checkType(t) || null === t)
									return t;
							var r = t[Symbol.toPrimitive];
							if (void 0 !== r) {
									var i = r.call(t, n || "default");
									if ("object" !== checkType(i))
											return i;
									throw new TypeError("@@toPrimitive must return a primitive value.")
							}
							return ("string" === n ? String : Number)(t)
					}(o, "string"),
					"symbol" === checkType(a) ? a : String(a)), i)
			}
			var o, a
	}
	var n = DS
		...
		, u = function() {
			function e(t, n, l) {
					...
					for (var u in this.slideWidth = c.get("width"),
					this.slideHeight = c.get("height"),
					this.temp = [],
					this.frame.layouts)
							this.temp.push(u);
					...
					i.on(o.controlOptions.CHANGED, (function(e) {
							...
							s.frame.controlOptions = e,
							s.setupControlOptions(),
							i.trigger(o.controlOptions.RESET),
							t && i.trigger(o.navData.REFRESH_VIEW)
					}
					)),
			...
			u = [{
					...
					value: function(e, t) {
							...
							t.forEach((function(r) {
									e(r),
									null != r.links && t.length > 0 && n.traverseMenu(e, r.links)
							}
							))
					}
			}, {
					...
					value: function(e) {
							...
							return null == n ? (c.includes(e) || (c.push(e),
							console.warn("could not find ".concat(e, " in string table ").concat(t))),
							e.replace("acc_", "").replace(/_/g, " ")) : n
					}
			}, {
					key: "setDocked",
					value: function(e, t, n) {
							t === a.docked.NONE ? (this.dockedStates[e] = null,
							delete this.dockedStates[e]) : this.dockedStates[e] = {
									dockedState: t,
									width: n
							};
							var r = Object.keys(this.dockedStates);
							0 === r.length ? this.dockSettings = {
									dockedState: a.docked.NONE,
									width: 0
							} : t !== a.docked.NONE ? this.dockSettings = {
									dockedState: t,
									width: n
	...
	var g, m = DS, w = m._, S = m.scaler, k = m.detection, O = m.detection.orientation, E = m.utils, C = E.getPath, x = E.scaleVal, L = E.pxify, P = m.dom, T = P.addClass, j = P.removeClass, D = m.constants.refs.FRAME, A = document.getElementById(DS.constants.els.PRESO), I = {
			x: "w",
			xl: "w",
			xp: "w",
			y: "h",
			...
			hl: "h",
			hp: "h"
	}, R = ["wrapper", "lightBoxWrapper"], B = function(e) {
			...
			n = [{
					...
					value: function(e) {
							if (this.hasInited)
									...
									r.visual && (this.el = document.createElement(r.tag || "div"),
					...
					value: function(e, t) {
							var n = "".concat(t, "l")
								, r = "".concat(t, "p");
							null != e[n] && null != e[r] && (e[t] = function() {
					...
					value: function() {
							...
							null != this.updateDomStrings && (this.updateDomStrings(),
					...
					key: "updateSize",
					value: function() {
							"button" === this.tag ? (this.el.style.width = L(x(Math.max(this.w, 24))),
							this.el.style.height = L(x(Math.max(this.h, 24)))) : (this.el.style.width = L(x(this.w)),
							this.el.style.height = L(x(this.h)))
					}
			}, {
					key: "updateTrans",
					value: function() {
							...
							if (this.xs)
									for (var n = 0; n < this.xs.length; n++)
											t.push("translateX(".concat(L(e(this.xs[n])), ")"));
							if (this.ys)
									for (var r = 0; r < this.ys.length; r++)
											t.push("translateY(".concat(L(e(this.ys[r])), ")"));
							k.deviceView.isMobile && null != this.scale && t.push("scale(".concat(this.scale, ")")),
					...
					value: function() {
							var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : function() {
								...
								, t = 0;
							return null != this.children && this.children.forEach((function(n) {
									e(n) && (n.update(),
									t += n.w)
							}
							)),
					...
					value: function() {
							var e = 0;
							return null != this.children && this.children.forEach((function(t) {
									t.update(),
									e += t.h
							}
							)),
					...
					value: function(e) {
							...
							v.forEach((function(e) {
									...
									!e.visible && "reflow" === e.visibility || "-" === t || (t ? W[t](e, b, i) : y(e, b, i),
									c(e))
							}
							)),
							d && (this[m] = b[S])
					...
					value: function(e) {
							(e = Object.assign({
									...
									rtl: !1,
									hook: function() {}
							}, e)).fullUpdate ? this.hasAllChildren() && (this.positionChildren(e),
							this.updateSize()) : this.positionChildren(e)
					}
			}, {
					key: "isBlocked",
					value: function() {
							if (k.theme.isClassic)
									return !1;
					...
					value: function(e, t) {
							...
							e ? j(this.el, "cs-disabled") : T(this.el, "cs-disabled"),
					...
					value: function(e, t) {
							var n = this.visible !== e
								, r = !1;
							return "no-reflow" === this.visibility ? (this.el.style.visibility = e ? "visible" : "hidden",
							this.el.style.pointerEvents = e ? "" : "none") : "reflow" === this.visibility && (this.el.style.display = e ? "block" : "none",
							r = !0),
					...
					value: function() {
							...
							(DS.flagManager.multiLangSupport || DS.flagManager.aiCourseTranslation) && (this.el.style.display = "block",
					...
					value: function() {
							var e = this;
							this.calcTextSize && this.doTextCalcs(),
							null != this.childViews && this.childViews.forEach((function(t) {
									"string" == typeof t && (t = G.getOrCreateView(t)),
									t.init(e.nameSpace),
									e.append(t)
							}
							))
					...
					value: function(e, t) {
							...
							null == e.nameSpace) {
									...
									G.hasNamespace(n.nameSpace) ? G.getNamespace(n.nameSpace)[e.nameKey] = e : console.warn("could not find namespace ".concat(n.nameSpace, " when appending"))
							}
					}
			}, {
					key: "destroy",
					...
					key: "endFloat",
					value: function() {
							this.floating && (this.floating = !1,
							this.shouldReparent && this.lastFloatParent.appendChild(this.el))
					}
			}, {
					key: "right",
					value: function() {
					...
					key: "getBox",
					value: function() {
							if (null == G.getNamespace(this.nameSpace).wrapper)
									return null;
	...
	var U = {}
		...
		, Q = function(e) {
			var t, n, r = d(e);
			return "string" === r ? t = e : "object" === r ? n = e[t = Object.keys(e)[0]] : console.warn("invalid view definition. ".concat(e, " is a ").concat(d(e))),
			{
					viewName: t,
					children: n
			}
		...
		, G = {
			...
			def: function(e, t, n) {
					...
					var r = new V(t,n);
					return null == U[e] ? (U[e] = r,
					K[e] = {
							ViewLogic: t,
							p: n
					},
					z[e] = 0) : console.warn("views connot share the same name ".concat(e)),
					r
			},
					...
					this.nameSpaces[g] = this.nameSpaces[g] || {
							...
							updateTabIndex: function() {
									...
									this.topLevelElements.forEach((function(i) {
											...
											t && (i.children.some((function(e) {
													return "startoverlay" === e.nameKey
											}
											)) ? i.children.filter((function(e) {
													return "startoverlay" !== e.nameKey
											}
											)).forEach((function(t) {
			...
			update: function(e) {
					...
					e.forEach((function(e) {
							w.isFunction(e) ? e() : Array.isArray(e) ? update(e, t) : null == e || !e.update || e.noUpdate && !t || (e.update(),
							t && e.updateHtml())
					}
					))
			}
			...
			tree: function(e, t) {
					for (var n = this, r = [], i = function t(r) {
							if (null !== r) {
									var i = Q(r)
										, o = i.viewName
										, a = i.children
									...
									if (null != l) {
											if (l.nameSpace = e,
											C(a, "length") > 0) {
													l.setChildNum(a.length),
													l.hasChildren = !0;
													for (var s = 0; s < a.length; s++)
															t(a[s])
											}
									} else
											console.warn("could not find view '".concat(o, "'"))
							}
					}, o = function t(i, o) {
							if (null !== i) {
									var a = Q(i)
									...
									if (null != c) {
											...
											console.warn("could not find view '".concat(l, "'"))
							}
					}, a = 0; a < t.length; a++)
							i(t[a]);
	...
	var J, ee = DS, te = ee._, ne = ee.pubSub, re = ee.events, ie = {}, oe = !1, ae = {}, le = function(e) {
			try {
	...
	null != J) {
			var se = function(e, t) {
					...
					if (oe) {
							...
							G.model;
							n = ".cs-".concat(G.model.frame.default_layout).concat(t),
							r = e
					}
			...
			var ce = function(e, t) {
					...
					return n.setAttribute("class", t),
					n
			}
				, ue = /^\./
				, fe = /\./g;
			ie.getColor = function(e, t, n) {
					var r, i, o = (arguments.length > 4 && void 0 !== arguments[4] && arguments[4] || t).split(/\s+/), a = G.getNamespace(e).wrapper.el;
					...
					return "" === l && "border-color" === n && (l = window.getComputedStyle(r).getPropertyValue("border-top-color")),
	...
	var ye, be, ve, ge, me = DS, we = me.dom, Se = me._, ke = me.detection, Oe = me.pubSub, Ee = me.events, Ce = function() {
			function e() {
					!function(e, t) {
							if (!(e instanceof t))
									throw new TypeError("Cannot call a class as a function")
			...
			(n = [{
					...
					value: function() {
							window.requestAnimationFrame((function() {
									...
									null != e && (DS.constants.theme.brandingHighlight = e,
									Oe.trigger(Ee.app.BRANDING_COLOR, e))
							}
							))
					}
			}, {
					...
					key: "onLoaderShow",
					value: function(e) {
							e > 0 ? this.showLoaderDelayed(e) : (this.getSpinLoader().style.display = "block",
			...
			e
	}(), xe = DS, Le = xe.globalEventHelper.addWindowListener, Pe = xe.events, Te = Pe.ds, _e = Te.FRAME_DATA_LOADED, je = Te.PRESO_READY, De = Pe.window.STACKING_CHANGED, Ae = Pe.frame, Ie = Ae.MODEL_READY, Re = Ae.SCALE, Be = Pe.resume.SET_DATA, Me = Pe.startOverlay.READY, He = Pe.controlOptions.RESET, Ne = Pe.sidebar.ACTIVE_TAB_SET, Fe = Pe.renderTree.DESTROYED, We = xe.constants, Ve = (We.els.PRESO,
	We.refs.FRAME), Ue = xe.detection.theme, Ke = xe.pubSub, ze = xe.focusManager, Qe = (xe.flagManager,
	xe.playerGlobals), Ge = xe.stringTabler, Ze = xe.shortcutManager, qe = xe.dom, Ye = {}, Xe = function(e) {
			var t = G.nsStack.indexOf(e);
			t >= 0 && G.nsStack.splice(t, 1)
	}, $e = function() {
			var e = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0];
			G.nsStack.forEach((function(t, n, r) {
					t.tabReachable = n === r.length - 1 && e,
					t.updateTabIndex()
			}
			))
	}, Je = function(e) {
			ye = {
					createWindow: function(t) {
							var n, r, i = this, o = G.getNamespace(t), a = function() {
									return function(e) {
											...
											G.nsStack.forEach((function(e, t) {
													var n = e.slide.el;
													t === r - 1 ? (qe.addClass(n, "primary-slide"),
													qe.removeClass(n, "secondary-slide")) : (qe.removeClass(n, "primary-slide"),
													qe.addClass(n, "secondary-slide"))
											}
											)),
											$e(),
											Ke.trigger(De, e)
									...
									if (e === t) {
											var i = r ? r.getWndBlockerBackground() : ""
												, a = G.getBlocker(e);
											null != a && (a.setBackgroundColor(i),
											a.setVisibility(n)),
											o.tabReachable = !n,
											o.updateTabIndex(!1, !0)
									}
							};
							return null == o && (G.addNameSpace(t),
							r = e[t](be),
							n = _.flow(Le("resize", (function() {
									r.resize(),
									Ke.trigger(Re)
							}
							...
							Ye[t] = r,
							o.moveToTop = a,
							Ue.isUnified && (Ke.on(DS.events.frameModel.BLOCKED_CHANGED, l),
							...
							)),
							{
									...
									close: function() {
											...
											o.detach(),
											Xe(o),
											G.nsStack[G.nsStack.length - 1].moveToTop(),
											ze.reCenter()
									},
									moveToTop: a,
									...
									onPinchZoom: Ye[t].pinchZoom ? function(e) {
											o.zoomBounds = e,
											Ye[t].pinchZoom()
									}
									: function() {}
			...
			ye.hasData = !0,
			Ke.trigger(_e, ye)
	}, tt = DS, nt = tt.MicroScrollBar, rt = tt.detection, it = function(e) {
	...
	function lt(e, t) {
			for (var n = 0; n < t.length; n++) {
					...
					"symbol" === at(o) ? o : String(o)), r)
			}
			var i, o
	}
	var st, ct = DS.detection, ut = new (function() {
			function e() {
					!function(e, t) {
							if (!(e instanceof t))
									throw new TypeError("Cannot call a class as a function")
			...
			(n = [{
					...
					key: "height",
					get: function() {
							return this.shouldUseCache() ? (this.cachedOuterHeight !== window.outerHeight && (this.cachedHeight = window.outerHeight - (this.cachedOuterHeight - this.cachedHeight),
							this.cachedOuterHeight = window.outerHeight),
							this.cachedHeight) : (this.cachedOuterHeight = window.outerHeight,
	...
	var dt, ht = "-20px", pt = "-30px";
	var yt = {
			setTooltipOn: function(e, t, n) {
					var r, i, o = t.left, a = t.top, l = t.width, s = t.height;
					null == st && (r = G.model,
					...
					var d = a - (s + 10);
					d <= 10 && (d = a + s + 10),
					st.style.left = "".concat(f, "px"),
					st.style.top = "".concat(d, "px")
			},
			hideTooltip: function(e) {
					null == st || null != e && e !== dt || (st.style.display = "none",
					st.innerText = "",
					st.style.left = 0,
					dt = void 0)
			},
	...
	mt.stringTabler)
		...
		, jt = function() {
			function e(t) {
					...
					DS.flagManager.multiLangSupport || DS.flagManager.aiCourseTranslation ? (t.simpleView || (DS._.bindAll(this, "onFocus", "onBlur", "onLayoutChange"),
					...
					this.el.addEventListener("focusout", this.onBlur),
					St.on(kt.frameModel.LAYOUT_CHANGED, this.onLayoutChange)),
					_t() && (Ot.bindAll(this, "onHoverIn", "onHoverOut", "onMainKeydown"),
			...
			(n = [{
					...
					value: function() {
							bt.hideTooltip(this),
							this.tooltipMoves && this.stopFollowMouse(),
							this.tooltipOn = !1
					}
			}, {
					key: "onHoverOut",
					value: function() {
							var e = this;
							_t() && this.hasTooltip && this.tooltipOn && setTimeout((function() {
					...
					key: "onMainKeydown",
					value: function(e) {
							Ct.isKey(e.which, Et.keys.ESCAPE) && (e.stopPropagation(),
							this.dismissTooltip())
					}
			}, {
					key: "teardown",
					value: function() {
							...
							Pt.deviceView.isUnifiedDesktop && (document.body.removeEventListener("mouseenter", this.onHoverOut),
							...
							this.tooltipOn && (this.onHoverOut(),
							this.tooltipMoves && this.stopFollowMouse()))
					}
			}, {
					key: "onLayoutChange",
	...
	var Qt, Gt, Zt = DS, qt = Zt.detection, Yt = Zt.events, Xt = Zt.pubSub, $t = function() {
			return document.getElementById("app-top") || document.body
	}, Jt = DS.utils.pxify, en = function(e) {
			!function(e, t) {
					if ("function" != typeof t && null !== t)
							throw new TypeError("Super expression must either be null or a function");
					e.prototype = Object.create(t && t.prototype, {
			...
			function o(e) {
					...
					(t = i.call(this, e)).visualNode = ((n = document.createElement("div")).className = "skipnav transparent",
	...
	function(e) {
			...
			function o(e) {
					...
					t.teardownPushableSlide = function(e) {
							var t;
							if (!un.deviceView.isPhone)
									return ln.noop;
							function n() {
									e.view.el.style.transition = null,
									e.view.el.style.top = "0px"
							}
							function r(t) {
									e.view.el.style.transition = dn;
									var n = .45 * window.innerHeight - 10
										, r = -(e.view.bottom() - n)
										, i = e.view.y + r
										, o = 0;
									i < fn && un.theme.isUnified ? o = fn - i + 10 : i < 0 && (o = -1 * i + 10),
									e.view.el.style.top = "".concat(r + o, "px")
							}
							function i() {
									e.view.el.style.transition = dn,
									e.view.el.style.top = "".concat(0, "px")
							}
							return sn.on((on(t = {}, cn.threeSixtyImage.UN_PUSH_LABEL, n),
			...
			(n = [{
					key: "onAriaToggle",
					value: function(e) {
							e.hidden ? (this.el.setAttribute("aria-hidden", !0),
							this.el.setAttribute("tabindex", 0)) : (this.el.removeAttribute("aria-hidden"),
							this.el.removeAttribute("tabindex"))
					}
			}, {
					key: "teardown",
					value: function() {
							wn.off(Sn.slide.HAS_MOUNTED, this.onSlideChange),
							this.teardownPushableSlide()
					}
			}, {
					key: "onSlideChange",
					value: function(e) {
							null != this.labelEl && this.view.nameSpace === e.props.windowId && (this.labelEl.textContent = "".concat(G.model.getString("slide"), ": ").concat(On.stripTags(e.props.model.title())))
					}
			}, {
					key: "onFocus",
					value: function() {}
	...
	G.def(In, Cn, (function(e) {
			...
			return {
					...
					h: function() {
							return jn.zoomMode ? Math.min(this.availH - (this.currWinScale <= 1 ? 9 : 0), window.innerHeight - (this.y + (this.bottomBarExists() ? i.h : 0))) : Math.round(o.slideHeight * this.currWinScale)
					},
					z: 1,
					style: {
							overflow: "scroll"
					...
					methods: {
							topBarExists: function() {
									return null != r && r.visible && (o.sidebarOpts.titleEnabled || o.sidebarOpts.sidebarEnabled || o.hasTopLinks() || o.frame.controlOptions.controls.elapsedandtotaltime)
							},
							bottomBarExists: function() {
									var e = !1;
									return null != i && i.visible && i.children && (e = i.children.some((function(e) {
											return e.visible
									}
									))),
							...
							calcSidebarOffsets: function() {
									var e = null != n && n.visible
										, t = e && "left" === n.pos;
									this.sidebarWidthOffset = t ? n.right() : e ? window.innerWidth - n.x : 0,
					...
					updateHook: function() {
							var e = this;
							if (jn.zoomMode) {
									null == this.scrollbar && (this.scrollbar = new Dn(this.el,"slide"),
									this.hscrollbar = new Dn(this.el,"slide",!0)),
									...
									window.requestAnimationFrame((function t() {
											e.el.getElementsByClassName("slide").length > 0 ? (e.scrollbar.update(),
											e.hscrollbar.update()) : window.requestAnimationFrame(t)
									}
									))
							} else
									this.scrollbar && (this.scrollbar.setEnabled(!1),
	...
	G.def(Bn, (function(e) {
			var t, n = G.model, r = G.getNamespace(e).sidebar, i = r.w, o = .75 * i;
			return {
					id: Bn,
					attrs: {
							class: "logo cs-logo",
					...
					updateHook: function() {
							o / 170 > i / r.data.actualWidth() ? (t.style.width = "auto",
							t.style.height = "100%") : (t.style.width = "100%",
							t.style.height = "auto")
					}
			}
	}
	...
	G.def(Nn, (function(e) {
			...
			var i = .25
				, o = function() {
					var e = t.dockSettings || {}
						...
						, a = Qn.device.isPhone ? .8 * window.innerWidth : o / 4;
			...
			return {
					...
					x: function() {
							var e = this
								, t = a();
							if (this.collapsed && ("left" === this.pos ? t -= o() : t += o()),
							this.animate && !this.animating) {
									var n = "left" === this.pos ? -30 : 30;
									this.collapsed && this.floating ? (Un.addClass(document.body, "sidebar-closing"),
									Vn.to(this.content, i, {
											opacity: 0,
											x: n,
											ease: "power4.out",
											onComplete: function() {
													Un.removeClass(document.body, "sidebar-closing"),
													Un.addClass(document.body, "sidebar-closed")
											}
									...
									var r = window.innerWidth
										, s = Vn.to(l, i, {
											...
											onUpdate: function() {
													"right" === e.pos && window.innerWidth != r && (s.kill(),
													e.animating = !1),
													zn.trigger(Kn.frame.REFLOW),
													zn.trigger(Kn.frame.SCALE)
											}
									});
									this.animating = !0
							}
							return this.animating || (l.x = t),
							this.floating ? "right" === this.pos ? (this.xs[0] = l.x - window.innerWidth,
							window.innerWidth) : (this.xs[0] = l.x,
							0) : (this.xs[0] = 0,
							l.x)
					},
					w: function() {
	...
	var ir = DS
		...
		, br = function(e) {
			...
			function o(e) {
					...
					(G.model.sidebarOpts.closed && pr || hr) && (fr(document.body, "sidebar-closed"),
					t.sidebar.collapsed = !0),
			...
			n = [{
					...
					key: "setExpandedAttr",
					value: function() {
							return this.el.setAttribute("aria-expanded", !this.sidebar.collapsed),
							this
					}
			}, {
					key: "animateSidebar",
					value: function() {
							this.animate || (this.sidebar.animate = !0,
							this.sidebar.update())
					}
			}, {
					key: "onResize",
					value: function(e, t) {
							...
							Xn(o) && this.sidebar.visible ? (this.sidebar.startFloat(),
							fr(document.body, yr),
							null == this.removeCollapseSidebarListener && (this.removeCollapseSidebarListener = cr("keyup", this.keyUpCollapseSidebar.bind(this)))) : (this.sidebar.endFloat(),
							dr(document.body, yr),
							null != this.removeCollapseSidebarListener && (this.removeCollapseSidebarListener(),
							this.removeCollapseSidebarListener = null));
							var a = window.innerWidth - o;
							!this.sidebar.collapsed && Xn(o) && (this.prevWidth > a || t) ? (this.sidebar.autoCollapsed = !0,
							this.sidebar.collapsed = !0,
							this.setExpandedAttr().animateSidebar()) : this.sidebar.autoCollapsed && !this.sidebar.floating && this.prevWidth < a && (this.sidebar.collapsed = !1,
					...
					value: function() {
							...
							), 250)) : this.setExpandedAttr().animateSidebar(),
							or.trigger(ar.hamburger.TOGGLE, this.sidebar.collapsed)
					}
			}, {
					key: "teardown",
					value: function() {
							hr = this.sidebar.collapsed,
							or.off(ar.sidebar.CLOSE),
							or.off(ar.sidebar.OPEN)
					}
			}],
			n && Jn(t.prototype, n),
			r && Jn(t, r),
	...
	function _r(e) {
			...
			return function() {
					...
					if (t) {
							...
							n = r.apply(this, arguments);
					return function(e, t) {
							if (t && ("object" === Or(t) || "function" == typeof t))
									return t;
							if (void 0 !== t)
									throw new TypeError("Derived constructors may only return object or undefined");
							return jr(e)
	...
	G.def(Sr, Dt, (function(e) {
			var t, n = G.model, r = G.model.frame, i = G.getNamespace(e), o = i.hamburger, a = i.sidebar, l = "right" === a.pos && !n.rtl, s = r.fontscale / 100;
			t = 1.23077 * s * 13 + xn;
			...
			return {
					...
					x: function() {
							...
							return "right" === a.pos && o.visible && (t -= e),
							t
					},
					y: "vertical-center",
					calcTextSize: !0,
					...
					h: 22,
					html: function() {
							return "<div data-ref='label' class=\"presentation-title-text\">".concat(c ? n.title.text : "", "</div> ").concat(l ? '<div class="top-tabs-line" style="height:'.concat(t, 'px;"></div>') : "")
					},
					methods: {
							updateDomStrings: function() {
	...
	var Ar = DS
		...
		, Fr = function(e) {
			...
			function o(e) {
					...
					Br.on((xr(t = {}, Rr.timer.SHOW, n.onShow),
					xr(t, Rr.timer.HIDE, n.onHide),
					t)),
			...
			(n = [{
					...
					value: function() {
							if (!Ir.deviceView.isClassicMobile) {
									...
									if (e && null != Nr[e.toLowerCase()])
											return e.toLowerCase();
									if (!G.model.sidebarOpts.timeEnabled)
											return "none"
							}
							return "remaining"
					}
					...
					value: function() {
							var e;
							Br.off((xr(e = {}, Rr.timer.SHOW, this.onShow),
							xr(e, Rr.timer.HIDE, this.onHide),
							e))
					}
			}, {
					key: "onTick",
					value: function(e, t, n) {
							if (this.view.children.timerText.el.innerHTML = Nr[this.timeFormat](t, n),
							!Ir.deviceView.isClassicMobile) {
					...
					key: "onHide",
					value: function() {
							null != this.currentTimer && (this.currentTimer.off("tick", this.onTick),
	...
	G.def(Ur, Wr, (function(e) {
			...
			return {
					...
					x: function() {
							...
							return "right" === i.pos && o.visible && (e -= o.w),
							Vr.deviceView.isPhone && (e += 4,
							Vr.orientation.isLandscape ? e = window.innerWidth - this.w - 5 : this.hasUpperRightElement() ? e -= 58 : e -= xn),
							e
					},
					y: function() {
							var e = Ln;
							return Vr.deviceView.isPhone && Vr.orientation.isLandscape && this.hasUpperRightElement() && (e += Ln),
							e
					},
					w: 220,
					h: 22,
		...
		, ii = function(e) {
			...
			function o(e) {
					...
					Xr(qr(t), "onTopEllipsesPanelShown", (function(e) {
							...
							t.showArrowShadow(n),
							t.lastWidget = ri.topEllipsesPanel
					}
					)),
	...
	function ui(e, t) {
			for (var n = 0; n < t.length; n++) {
					...
					"symbol" === li(o) ? o : String(o)), r)
			}
			var i, o
	}
	function fi() {
			return fi = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function(e, t, n) {
					var r = function(e, t) {
		...
		, Pi = function(e) {
			...
			(n = [{
					...
					value: function(e, t) {
							...
							null != n ? (n.viewLogic.showPanel(),
							Si.trigger(ki.sidebar.OPEN)) : document.body.classList.contains("floating-sidebar") && Si.trigger(ki.sidebar.CLOSE)
					}
			}, {
					key: "onActiveTabSet",
					value: function(e) {
							...
							if (null != G.model && 0 !== this.view.children.length) {
									var n = (G.model.sidebarTabs || []).reduce((function(n, r) {
											var i = r.name
												, o = e[i]
												, a = "".concat(i, "Tab");
											return (vi.isObject(o) ? !0 === o.enabled : !0 === o) && null != t.view.children[a] && n.push(t.view.children[a]),
											n
									}
									), []);
					...
					value: function(e) {
							...
							Ci("keydown", this.onKeydown))
					}
			}, {
					key: "onBlur",
					value: function(e) {
							this.el.contains(e.relatedTarget) || (this.isFocused = !1,
							fi(yi(o.prototype), "onBlur", this).call(this),
							xi("keydown", this.onKeydown))
					}
			}, {
					key: "onKeydown",
					value: function(e) {
							var t = this.currentTab;
							gi.isActionKey(e.which) ? (this.activeTab = this.currentTab,
							this.activateTab()) : gi.isRightKey(e.which) ? this.currentTab = this.getNextTab(this.currentTab.model.idx) : gi.isLeftKey(e.which) ? this.currentTab = this.getPrevTab(this.currentTab.model.idx) : gi.isHomeKey(e.which) ? this.currentTab = this.getFirstTab() : gi.isEndKey(e.which) && (this.currentTab = this.getLastTab()),
							t !== this.currentTab && (null != t && (t.el.tabIndex = -1),
							this.setCurrent())
					}
			}, {
					key: "activateTab",
					value: function() {
							null != this.activeTab && (vi.forEach(this.view.children, (function(e) {
					...
					value: function() {
							this.view.visible && (null != this.activeTab && this.activeTab.visible || (this.currentTab = this.activeTab = vi.first(this.getLiveChildren())),
							this.activateTab())
					}
			}, {
					key: "setCurrent",
					...
					key: "teardown",
					value: function() {
							Si.off(ki.sidebar.ACTIVE_TAB_SET),
							o.lastSelectedTab = this.getSelectedTab(),
	...
	function Hi() {
			return Hi = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function(e, t, n) {
					var r = function(e, t) {
	...
	var Ki = DS
		...
		, Xi = function(e) {
			...
			function o(e) {
					...
					n = Wi(t),
					a = "search_toggle",
					(r = Ui(r = "tooltipKey"))in n ? Object.defineProperty(n, r, {
							value: a,
							enumerable: !0,
							configurable: !0,
							writable: !0
					...
					return t.tabSelectedSlider = l.tabSelectedSlider.el,
					t.sliderMask = l.sliderMask.el,
			...
			n = [{
					...
					value: function(e) {
							o.showingSearch || (qi.trigger(Zi.sidebar.SHOW_SEARCH),
					...
					key: "didChangeVisibility",
					value: function(e) {
							Hi(Vi(o.prototype), "didChangeVisibility", this).call(this, e),
					...
					value: function() {
							...
							Qi.addClass(this.el, "selected-animation-done"),
					...
					value: function() {
							this.showSlider(),
							zi.to(this.tabSelectedSlider, .25, {
									x: this.view.x,
									width: this.view.w || 0,
					...
					key: "showPanel",
					value: function(e) {
							"searchTab" !== this.view.nameKey ? (Hi(Vi(o.prototype), "showPanel", this).call(this, e),
							this.animateSlider(),
							o.showingSearch = !1) : (this.onToggleSearchInput(),
							o.showingSearch = !0)
					}
			}, {
					key: "isLive",
			...
			return {
					...
					updateHook: function() {
							...
							for (var o = 0, l = 0; l < t; l++)
									o += this.children[l].lastWidthByText;
							a ? n || (o += 33) : e -= 50;
							var s, c = o > e;
							c ? ro.addClass(this.el, "overflow-tabs") : ro.removeClass(this.el, "overflow-tabs");
							for (var u = 0; u < t; u++)
									s = this.children[u],
									a && u === t - 1 ? (s.x = n ? xn : e - s.lastWidthByText,
									s.update()) : s.width = c ? Math.min(s.lastWidthByText, r - 3) : s.lastWidthByText
					},
					childDef: function() {
							ao(G.model, a)
					},
	...
	function(e, t) {
			var n = !1
				, r = no(e, "sidebarTabs", []);
			e.outlineInSidebar && t && !r.some((function(e) {
					...
					var i = function(e, t, n, r) {
							var i = t.name
								...
								, u = G.def(s, $i, {
									...
									updateHook: function() {
											u.viewLogic.updateSliderLayout(),
									...
									methods: {
											...
											updateStrings: function() {
													...
													this.el.setAttribute("aria-label", e.getString(r)),
													t.isIcon || (this.content.textContent = e.getString(r)),
													this.doTextCalcs()
											}
									}
							});
							return u.init(),
							G.getNamespace(io).tabs.append(u),
							c
					}(e, t, r, n);
					n = i || n
			}
	...
	function so(e, t) {
			for (var n = 0; n < t.length; n++) {
					...
					"symbol" === lo(o) ? o : String(o)), r)
			}
			var i, o
	}
	function co() {
			return co = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function(e, t, n) {
					var r = function(e, t) {
	...
	var yo = DS
		...
		, wo = (mo.addDocumentListener,
	mo.removeDocumentListener,
	yo.keyManager.isTabKey,
	yo.playerGlobals)
		, So = yo.utils
		, ko = function(e) {
			!function(e, t) {
					...
					value: function(e) {
							if (!wo.presentation.isPreview() || window.globals.HAS_SLIDE)
									if (DS.flagManager.aiCourseTranslation) {
											...
											go.deviceView.isDesktop && null != t && !t.translationShown && this.isTargetOutsidePanel(e.relatedTarget) && (co(po(o.prototype), "onBlur", this).call(this, e),
											t.viewLogic.hidePanel())
									} else
											go.deviceView.isDesktop && null != this.view.lnk && this.isTargetOutsidePanel(e.relatedTarget) && (co(po(o.prototype), "onBlur", this).call(this, e),
											this.view.lnk.viewLogic.hidePanel())
					}
			}, {
					key: "isTargetOutsidePanel",
					value: function(e) {
							return null == e || !this.el.contains(e) && bo.camelCase(e.id) !== this.view.lnk.nameKey && bo.camelCase(e.parentElement.id) !== this.view.lnk.nameKey
					}
			}, {
					key: "onShow",
					value: function(e) {
							...
							if (this.view.nameKey === t) {
									...
									for (var i in n)
											i.indexOf("Panel") > -1 && n[i].viewLogic.onHide();
									this.el.style.display = "block",
									null != r.onPanelVisible && r.onPanelVisible()
							}
					}
			}, {
					key: "onHide",
	...
	function Co(e, t) {
			for (var n = 0; n < t.length; n++) {
					...
					"symbol" === Eo(o) ? o : String(o)), r)
			}
			var i, o
	}
	function xo(e, t) {
			return xo = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(e, t) {
					return e.__proto__ = t,
					e
			}
			,
	...
	function Lo(e) {
			...
			return function() {
					...
					if (t) {
							...
							n = r.apply(this, arguments);
					return function(e, t) {
							if (t && ("object" === Eo(t) || "function" == typeof t))
									return t;
							if (void 0 !== t)
									throw new TypeError("Derived constructors may only return object or undefined");
							return function(e) {
			...
			n = [{
					...
					value: function() {
							...
							if (null != t) {
									...
									To.deviceView.isUnifiedMobile ? (r.style.pointerEvents = "none",
									setTimeout((function() {
											r.style.pointerEvents = "all"
									}
									), 100)) : r.focus()
							} else
									n.viewLogic.focusSelf()
					}
			}, {
					key: "onFocus",
					value: function() {}
	...
	var Ho = DS
		...
		, Go = function(e) {
			...
			function o(e) {
					...
					return n.addEventListener("submit", t.onSearch.bind(Bo(t))),
					zo.deviceView.isMobile && (Uo(Bo(t), "onMobileOutlineShown"),
					r.addEventListener("input", t.onSearch.bind(Bo(t))),
					No.on(Fo.mobile.OUTLINE_SHOWN, t.onMobileOutlineShown)),
			...
			n = [{
					key: "teardown",
					value: function() {
							No.off(Fo.mobile.OUTLINE_SHOWN, this.onMobileOutlineShown),
							No.off(Fo.controlOptions.RESET, this.onControlOptionsReset, this),
							Qo = !1
					}
			}, {
					key: "ensureEventSubscriptions",
					value: function() {
							Qo || (No.on(Fo.controlOptions.RESET, this.onControlOptionsReset, this),
							Qo = !0)
					}
			}, {
	...
	function Yo(e, t) {
			for (var n = 0; n < t.length; n++) {
					...
					"symbol" === qo(o) ? o : String(o)), r)
			}
			var i, o
	}
	function Xo() {
			return Xo = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function(e, t, n) {
					var r = function(e, t) {
	...
	var na = DS
		...
		, da = function(e) {
			...
			function o(e) {
					...
					G.model.outlineInSidebar || (t.toggle = !0,
					t.searchInput.style.opacity = 1,
					t.searchInput.style.display = "block");
					return t.searchInputField = t.view.children.searchInput.el,
					t.searchInputField.addEventListener("input", t.onSearchTermChanged.bind(ea(t))),
					fa.browser.isWebKit || t.searchInputField.addEventListener("keydown", (function(e) {
			...
			n = [{
					...
					key: "onSearch",
					value: function(e) {
							this.isSearchFieldEmtpy() ? e.preventDefault() : (Xo(ta(o.prototype), "onSearch", this).call(this, e),
							ca(this.clearEl, "hidden"),
							ra.trigger(ia.search.UPDATE_PANEL))
					}
			}, {
					...
					key: "clearSearch",
					value: function() {
							sa(this.clearEl, "hidden"),
							ra.trigger(ia.search.CLEAR)
					}
			}, {
	...
	function va(e, t) {
			for (var n = 0; n < t.length; n++) {
					...
					"symbol" === ba(o) ? o : String(o)), r)
			}
			var i, o
	}
	function ga() {
			return ga = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function(e, t, n) {
					var r = function(e, t) {
	...
	Oa.dom)
		...
		, Ha = function(e) {
			...
			(n = [{
					...
					value: function() {
							var e = this;
							xa.device.isMobile ? (this.el.addEventListener("touchmove", (function(t) {
									e.moved = !0
							}
							)),
							this.onClick((function(t) {
									e.moved || e.onClickItem(t),
									e.moved = !1
							}
					...
					key: "onFocus",
					value: function() {
							!this.isFocused && this.hasListItems() && (this.isFocused = !0,
					...
					key: "onBlur",
					value: function(e) {
							this.el.contains(e.relatedTarget) || (ga(ka(o.prototype), "onBlur", this).call(this, e),
							null != this.currentItem && (Aa(this.currentItem, "hover"),
					...
					value: function(e) {
							...
							Ca.isActionKey(e.which) ? (this.activateItem(e),
							Ca.isSpaceKey(e.which) && e.preventDefault()) : Ca.isDownishKey(e.which) ? this.currentItem = this.getNextItem(this.getItemContent()) : Ca.isUpishKey(e.which) ? this.currentItem = this.getPrevItem(this.getItemContent()) : Ca.isHomeKey(e.which) ? this.currentItem = this.getFirstItem() : Ca.isEndKey(e.which) && (this.currentItem = this.getLastItem()),
							t !== this.currentItem && (e.preventDefault(),
							t.tabIndex = -1,
							Aa(t, "hover"),
							this.focusOnCurrent())
					}
					...
					value: function() {
							...
							document.activeElement !== this.currentItem && (this.currentItem.tabIndex = 0,
							Da(this.currentItem, "hover"),
					...
					value: function(e) {
							var t = this
								, n = this.getItems().findIndex((function(n) {
									return t.findIndexCb(n, e)
							}
							)) + 1;
							return n === this.getItems().length && (n = 0),
							this.getItems()[n]
					}
			}, {
					key: "getPrevItem",
					value: function(e) {
							...
							return -1 === n && (n = this.getItems().length - 1),
							this.getItems()[n]
					}
			}, {
					key: "getLastItem",
	...
	function qa(e, t) {
			for (var n = 0; n < t.length; n++) {
					...
					"symbol" === Fa(o) ? o : String(o)), r)
			}
			var i, o
	}
	function Ya(e, t, n) {
			return t && qa(e.prototype, t),
			n && qa(e, n),
			Object.defineProperty(e, "prototype", {
					writable: !1
			}),
	...
	Ja.detection)
		...
		, kl = function(e) {
			...
			function n(e) {
					...
					r.animationDuration = .2;
					var i = G.model.frame.notesData || [];
					return r.notesBySlideId = i.map((function(e) {
					...
					r.slideTextBySlideId = r.slideTextData.filter((function(e) {
							return !e.slidebank
					}
					)).map((function(e) {
			...
			return Ya(n, [{
					...
					value: function() {
							this.slideBankTextBySlideId = this.slideTextData.filter((function(e) {
									...
									return null !== n && e.push(new Sl(n.absoluteId,n.title(),pl(t.Text))),
									e
							}
							), [])
					}
					...
					key: "teardown",
					value: function() {
							il.off(rl.window.MAIN_CHANGED, this.onSlideChanged),
							window.globals.HAS_SLIDE && il.off(rl.search.CLEAR, this.onClear)
					}
			}, {
					key: "onSlideChanged",
					value: function(e) {
							...
							null != t && sl(t, "cs-selected"),
							null != n && (cl(n, "cs-selected"),
							cl(n, "cs-viewed"),
					...
					value: function(e) {
							...
							if (this.el.contains(t)) {
									if (t === this.searchFilterEl || t === this.clearEl)
											return tl.setFocusRectOn(t),
											this.isFocused = !1,
											!1;
									if (t === this.notesCheckEl || t === this.slideCheckEl)
											return tl.setFocusRectOn(t.parentElement),
											this.isFocused = !1,
											!1;
									if (!this.isFocused && (!ml.isUnified || ol.isShowFocus)) {
											var n = Va(this.getItems(), 1)[0];
											this.isFocused = !0,
											null != n && (this.currentItem = n,
											this.lastSelected !== this.currentItem && this.focusOnCurrent(),
											vl("keydown", this.onKeydown))
									}
							}
							return !1
					}
					...
					value: function(e) {
							...
							n ? (clearTimeout(this.checkBoxTimeout),
							this.checkBoxTimeout = setTimeout((function() {
									t.setCheckboxesVisible(n)
							}
							), 200)) : this.setCheckboxesVisible(n)
					}
			}, {
					key: "onClickLink",
					value: function(e) {
							if ("locked" !== this.menuOptions.flow) {
									var t = ul(e.target, "listitem")
										, n = t.dataset.slideId;
									null == n || "restricted" === this.menuOptions.flow && !e.target.classList.contains("cs-viewed") || (cl(t, "cs-viewed"),
									this.updateAriaLabel(t),
									il.trigger(rl.request.NEXT_SLIDE, n))
							}
					}
			}, {
					key: "updateAriaLabel",
					value: function(e) {
							ml.isUnified && Wa(e.querySelector(".outline-states").children).forEach((function(t) {
					...
					value: function(e) {
							for (var t = 0; t < e.length; t++) {
									var n = e[t];
									$a(n) || this.searchResults.has(n.slideid) || (this.noSearchTerm || n.displaytext.toLowerCase().indexOf(this.term) >= 0) && this.searchResults.set(n.slideid, n.displaytext),
					...
					value: function() {
							...
							if (window.globals.HAS_SLIDE) {
									...
									this.hasSlideBankSlides && void 0 === this.slideBankTextBySlideId && this.loadSlideBankSearchData();
									var r = function(t) {
					...
					key: "getItems",
					value: function() {
							return this.items = this.items || Wa(this.el.querySelectorAll(".cs-listitem")),
							this.items
					}
			}, {
					key: "activateItem",
	...
	function Tl(e, t) {
			for (var n = 0; n < t.length; n++) {
					...
					"symbol" === xl(o) ? o : String(o)), r)
			}
			var i, o
	}
	function _l() {
			return _l = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function(e, t, n) {
					var r = function(e, t) {
	...
	var Rl, Bl, Ml, Hl = DS, Nl = Hl.detection, Fl = Hl.pubSub, Wl = Hl._, Vl = Hl.events, Ul = Hl.keyManager, Kl = Hl.resolver, zl = Hl.windowManager, Ql = Hl.utils.prefixWithPlayer, Gl = Hl.focusManager.setFocusRectOn, Zl = Hl.globalEventHelper.addDocumentListener, ql = Hl.dom, Yl = ql.parentNodesOf, Xl = ql.getParentWithClass, $l = ql.hasClass, Jl = ql.addClass, es = ql.removeClass, ts = function(e) {
			return Yl(e, (function(e) {
					return "li" === e.nodeName.toLowerCase()
			}
			))
	}, ns = function(e) {
			return ts(e).slice(1).some((function(e) {
			...
			function o(e) {
					...
					t = i.call(this, e),
					Wl.bindAll(Al(t), "updateVisitedSlides", "onSlideChanged", "onSelectFirstSlideLink", "addSlideToVisited", "visuallyUpdateLinks", "collapseLastItem", "onClickLink", "onCarrotClick", "onClickItem", "centerOnFocused", "setDrawSlides", "mouseDown", "mouseUp"),
					...
					Fl.on(Vl.navData.REFRESH_VIEW, (function() {
							if (DS.flagManager.multiLangSupport) {
									...
									t.view.updateHtml(),
									t.view.update(),
									t.view.initChildRefs(),
									t.visuallyUpdateLinks();
			...
			n = [{
					key: "teardown",
					value: function() {
							Fl.off(Vl.window.MAIN_CHANGED, this.onSlideChanged),
							Fl.off(Vl.mobile.OUTLINE_SHOWN, this.centerOnFocused),
					...
					value: function() {
							var e = this;
							this.isMouseDown || (null != this.view.parent.children.search && Nl.theme.isUnified ? setTimeout((function() {
									e.el.contains(document.activeElement) && _l(Il(o.prototype), "onFocus", e).call(e)
							}
							), 500) : _l(Il(o.prototype), "onFocus", this).call(this))
					}
			}, {
					key: "mouseDown",
					value: function() {
					...
					value: function(e) {
							...
							if (Nl.theme.isUnified) {
									...
									$l(e.target, "carrot") && (t.onCarrotClick(n),
									1) || n && $l(n.parentNode, "item-collapsible") && (t.onCarrotClick(n),
									!$l(n, "is-promoted-slide")) || "locked" !== t.menuOptions.flow && t.onClickLink(n)
							} else
									("locked" !== this.menuOptions.flow ? this.onClickLink : this.onCarrotClick)(e.target)
					}
			}, {
					...
					value: function() {
							...
							Nl.theme.isUnified && (this.setComplete("div.is-promoted-slide"),
					...
					value: function(e) {
							...
							Array.from(r).forEach((function(e) {
									Array.from(e.parentNode.querySelectorAll("div")).slice(n).every((function(e) {
					...
					value: function(e, t) {
							null != e && (e.forEach(this.addSlideToVisited),
							this.visuallyUpdateLinks())
					}
			}, {
					key: "getNextItem",
					value: function(e) {
							var t, n = this, r = this.getItems(), i = r.findIndex((function(t) {
					...
					key: "onSlideChanged",
					value: function(e) {
							if (this.addSlideToVisited(e),
							!this.currentItem || Xl(this.currentItem, "listitem").getAttribute("data-ref") != e.absoluteId) {
									var t = e.absoluteId
										, n = this.view.children[t];
									if (null == n) {
											var r = e.getSlideDraw();
											null != r && (t = r.absoluteId,
											n = this.view.children[t])
									}
					...
					value: function(e, t) {
							...
							Yl(e, (function(r) {
									r.classList.contains("item-collapsed") && (n.isCurrentLinkParent(e, t) || (es(r, "item-collapsed"),
					...
					value: function(e) {
							var t = this;
							null != this.lastExpandedEls && this.menuOptions.autocollapse && this.lastExpandedEls.forEach((function(n) {
					...
					key: "toggleScene",
					value: function(e) {
							var t, n = $l(e, "item-collapsed");
							if (t = n ? "remove" : "add",
							e.classList[t]("item-collapsed"),
							...
							if (e)
									if (Nl.theme.isUnified) {
											...
											if ("restricted" !== this.menuOptions.flow || t || this.visitedSlides.has(r)) {
													if (null != this.currentItem && e !== this.currentItem && (this.currentItem.tabIndex = -1,
													es(this.currentItem, "hover")),
													this.currentItem = e,
													null != r && (this.collapseLastItem(e),
													this.lastExpandedEls = this.collapsibleParents(e),
													this.lastExpandedEls.forEach((function(e) {
															var t = e.firstElementChild;
															r.includes(t.getAttribute("data-ref")) && (Jl(t, "cs-viewed"),
															n.updateAriaLabel(t))
													}
													))),
													$l(e, "listitem")) {
															...
															$l(e, "is-scene") || (null != o && (es(o, "cs-selected"),
													...
													if (i && !t) {
															...
															r != a && (Fl.trigger(Vl.request.NEXT_SLIDE, r),
															Nl.theme.isUnified && Fl.trigger(Vl.topEllipsesPanel.HIDE)),
															Nl.deviceView.isMobile && (Fl.trigger(Vl.tab.HIDE),
															(Nl.deviceView.isPhone || Nl.theme.isClassic) && Fl.trigger(Vl.sidebar.CLOSE))
													}
													null != this.currentItem && null != this.focusor && Gl(this.currentItem)
											}
									} else
											this.onClickLinkOld(e, t)
					}
			}, {
					key: "onClickLinkOld",
					value: function(e, t) {
							...
							if ("UL" !== e.nodeName)
									if ("restricted" !== this.menuOptions.flow || t || this.visitedSlides.has(n)) {
											...
											null != n && (this.collapseLastItem(e),
											this.lastExpandedEls = this.collapsibleParents(e),
											...
											$l(e, "listitem")) {
													Jl(e, "cs-viewed");
													var o = this.el.querySelector(".cs-selected");
													null != o && es(o, "cs-selected"),
													Jl(e, "cs-selected")
											} else
													this.onCarrotClick(e);
											if (r && !t) {
													var a = zl.getCurrentWindowSlide().absoluteId;
													i || n == a || (Fl.trigger(Vl.request.NEXT_SLIDE, n),
													Nl.theme.isUnified && Fl.trigger(Vl.topEllipsesPanel.HIDE)),
													Nl.deviceView.isMobile && (Fl.trigger(Vl.tab.HIDE),
													(Nl.deviceView.isPhone || Nl.theme.isClassic) && Fl.trigger(Vl.sidebar.CLOSE))
											}
											...
											$l(e, "carrot") && this.onCarrotClick(e)
					}
			}, {
					...
					value: function(e) {
							var t = this.currentItem;
							if (Ul.isActionKey(e.which))
									this.activateItem(),
									Ul.isSpaceKey(e.which) && e.preventDefault();
							else if (Ul.isRightKey(e.which) && t.dataset.hasLinks)
									$l(this.currentItem.parentNode, "item-collapsed") ? this.onCarrotClick(this.currentItem.firstElementChild) : this.currentItem = this.getNextItem(this.getItemContent());
							else if (Ul.isDownKey(e.which))
									this.currentItem = this.getNextItem(this.getItemContent());
							else if (Ul.isUpKey(e.which))
									...
									Ul.isHomeKey(e.which) ? this.currentItem = this.getFirstItem() : Ul.isEndKey(e.which) && (this.currentItem = this.getLastItem());
							t !== this.currentItem && (e.preventDefault(),
							es(t, "hover"),
					...
					value: function() {
							this.centerOnFocused(),
							document.activeElement !== this.currentItem.parentNode && (this.currentItem.parentNode.tabIndex = 0,
							Jl(this.currentItem, "hover"),
					...
					key: "getItems",
					value: function() {
							return this.links = this.links || Ll(this.el.querySelectorAll(".cs-listitem")),
							this.links
					}
			}, {
					key: "activateItem",
					...
					key: "getOffsetTop",
					value: function(e) {
							return Nl.deviceView.isMobile ? Wl.first(Yl(e, (function(e) {
									return "li" === e.nodeName.toLowerCase()
							}
							))).offsetTop : _l(Il(o.prototype), "getOffsetTop", this).call(this, e)
					}
			}, {
					key: "onShowTabItem",
					value: function(e, t) {
					...
					value: function() {
							var e = this;
							Nl.deviceView.isMobile && (this.currentItem = this.getItems().find((function(t) {
							...
							this.view.draws.forEach((function(t) {
									var n = t.link
										...
										, o = function() {
											var t = n.spliceNum || 1
												, o = i.slides();
											r.splice.apply(r, [n.index, t].concat(Ll(o.map(e.createNewLink)))),
											n.spliceNum = o.length,
											e.view.updateHtml(),
											e.view.initChildRefs()
									};
									i.on(Vl.draw.RESET_COMPLETE, o),
									null != i.slides() && o()
							}
							))
					}
			...
			return {
					...
					html: function() {
							var t = this
								, n = {}
								, r = 0;
							DS.flagManager.multiLangSupport && this.el.querySelectorAll("[data-collapsible-id]").forEach((function(e) {
							...
							function i(o, u, f) {
									...
									d.depth = u.depth + 1,
									d.tabIndex = -1,
									null != f ? d.setAttribute("role", "group") : (d.setAttribute("aria-label", e.getString("outline")),
									d.setAttribute("role", "tree")),
									u.appendChild(d);
									for (var h = 0; h < o.length; h++) {
											...
											p.innerHTML = E,
											b && (DS.flagManager.multiLangSupport && p.setAttribute("data-collapsible-id", r),
	...
	function ks(e) {
			...
			return function() {
					...
					if (t) {
							...
							n = r.apply(this, arguments);
					return function(e, t) {
							if (t && ("object" === vs(t) || "function" == typeof t))
									return t;
							if (void 0 !== t)
									throw new TypeError("Derived constructors may only return object or undefined");
							return Os(e)
	...
	function(e) {
			...
			function o(e) {
					...
					n = Os(t),
					a = void 0,
					(r = Cs(r = "s"))in n ? Object.defineProperty(n, r, {
							value: a,
							enumerable: !0,
							configurable: !0,
							writable: !0
					}) : n[r] = a,
					t.view.isUnified && (t.getScrollEl = function() {
							return t.termsEl
					}
					,
			...
			(n = [{
					...
					value: function(e) {
							...
							if (this.hasDefinition && null != t && "p" !== t.nodeName.toLowerCase()) {
									...
									n && (this.activeItem.firstElementChild.setAttribute("aria-expanded", !1),
									this.activeItem.style.backgroundColor = "",
									this.closeItem(this.activeItem)),
									n && this.lastSelected == t || (t.setAttribute("aria-expanded", !0),
					...
					key: "getNextItem",
					value: function(e) {
							var t, n = this.getItems(), r = this.getItems().indexOf(this.currentItem);
							do {
									(r += 1) === n.length && (r = 0),
									t = n[r]
					...
					key: "getItems",
					value: function() {
							return this.links = this.links || gs(this.el.querySelectorAll(".term")),
							this.links
					}
			}, {
					key: "openItem",
					...
					value: function(e) {
							...
							TweenLite.to(e, .2, {
									...
									onComplete: function() {
											...
											Ls.setFocusRectOn(t.currentItem)
									}
							})
					}
			}, {
	...
	function Ns(e, t) {
			for (var n = 0; n < t.length; n++) {
					...
					"symbol" === Bs(o) ? o : String(o)), r)
			}
			var i, o
	}
	function Fs(e, t) {
			return Fs = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(e, t) {
					return e.__proto__ = t,
					e
			}
			,
	...
	Ks.pubSub)
		...
		, Zs = function(e) {
			...
			(n = [{
					...
					key: "getItems",
					value: function() {
							return this.items = this.items || Ms(this.el.querySelectorAll(".resource a")),
							this.items
					}
			}, {
					key: "activateItem",
					value: function(e) {
							Gs(e.keyCode) && DS.windowOpen.open({
	...
	var $s = DS.utils
		...
		, uc = G.def(cc, Rs, (function() {
			var e = G.model;
			return ac.activeMobileMenuItem(e.frame.glossaryData, "no-glossary"),
			{
					attrs: {
	...
	function pc(e) {
			...
			return function() {
					...
					if (t) {
							...
							n = r.apply(this, arguments);
					return function(e, t) {
							if (t && ("object" === fc(t) || "function" == typeof t))
									return t;
							if (void 0 !== t)
									throw new TypeError("Derived constructors may only return object or undefined");
							return yc(e)
	...
	gc.slideObjectUtils)
		, Ec = function(e) {
			...
			function o(e) {
					...
					mc.deviceView.isClassicMobile ? kc.on(wc.mobile.NOTES_SHOWN, t.onHamburgerToggle.bind(yc(t), !1)) : mc.deviceView.isUnifiedMobile && kc.on(wc.hamburger.TOGGLE, t.onHamburgerToggle.bind(yc(t))),
			...
			(n = [{
					...
					value: function(e) {
							this.forceScrollToTop && !e && (this.getScrollElement().scrollTop = 0,
					...
					value: function() {
							this.el.focus(),
							Sc.setFocusRectOn(this.el.parentNode)
					}
			}, {
					key: "focusSelf",
					value: function() {
					...
					key: "handleTab",
					value: function() {
							return this.el.parentElement.focus(),
							!0
					}
			}, {
					key: "onSlideChanged",
					...
					key: "scrollToTop",
					value: function() {
							mc.deviceView.isDesktop ? this.view.el.scrollTop = 0 : mc.theme.isClassic ? 0 === this.getScrollElement().scrollTop ? this.forceScrollToTop = !0 : this.getScrollElement().scrollTop = 0 : G.getNamespace(this.view.nameSpace).sidebar.collapsed ? this.forceScrollToTop = !0 : this.getScrollElement().scrollTop = 0
					}
			}, {
					...
					value: function() {
							...
							mc.deviceView.isClassicMobile ? kc.off(wc.mobile.NOTES_SHOWN, this.onHamburgerToggle.bind(this, !1)) : mc.deviceView.isUnifiedMobile && kc.off(wc.hamburger.TOGGLE, this.onHamburgerToggle.bind(this))
					}
			}]) && dc(t.prototype, n),
			r && dc(t, r),
			Object.defineProperty(t, "prototype", {
	...
	function(e, t) {
			Pc(e, "sidebarTabs", []).forEach((function(e, n) {
					!function(e, t, n, r) {
							...
							l.init(),
							G.getNamespace(Tc).sidebarPanels.append(l);
							var s = Lc[i];
							null != s && (s.nameSpace = r,
							s.init(),
							l.append(s))
					}(0, e, n, t)
			}
	...
	function Ic(e, t) {
			for (var n = 0; n < t.length; n++) {
					...
					"symbol" === Ac(o) ? o : String(o)), r)
			}
			var i, o
	}
	function Rc(e, t) {
			return Rc = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(e, t) {
					return e.__proto__ = t,
					e
			}
			,
	...
	function Mc(e) {
			return Mc = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function(e) {
					return e.__proto__ || Object.getPrototypeOf(e)
			}
			,
			Mc(e)
	...
	function Vc() {
			return Vc = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function(e, t, n) {
					var r = function(e, t) {
	...
	function Qc(e) {
			return Qc = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function(e) {
					return e.__proto__ || Object.getPrototypeOf(e)
			}
			,
			Qc(e)
	...
	var Gc = DS.dom.isWithin
		...
		, ou = function(e) {
			...
			n = [{
					...
					value: function(e) {
							this.hidePanel(),
							this.view.nameKey.includes(e) && this.showPanel(!0)
					}
			}, {
					key: "onActiveTabSet",
					value: function(e) {
					...
					key: "onBlur",
					value: function(e) {
							tu.presentation.isPreview() && !window.globals.HAS_SLIDE || this.onCheckShouldHide({
					...
					value: function() {
							$c.off(Jc.controlLayout.CHANGED, this.hidePanel),
							$c.off(Jc.sidebar.ACTIVE_TAB_SET)
					}
			}],
			n && Wc(t.prototype, n),
			r && Wc(t, r),
	...
	function su(e, t) {
			for (var n = 0; n < t.length; n++) {
					...
					"symbol" === lu(o) ? o : String(o)), r)
			}
			var i, o
	}
	function cu() {
			return cu = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function(e, t, n) {
					var r = function(e, t) {
	...
	function uu(e, t) {
			return uu = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(e, t) {
					return e.__proto__ = t,
					e
			}
			,
	...
	function hu(e) {
			return hu = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function(e) {
					return e.__proto__ || Object.getPrototypeOf(e)
			}
			,
			hu(e)
	...
	var pu = DS
		...
		, Du = function(e) {
			...
			function o(e) {
					...
					t.isOutlinePanel && (vu.on(bu.menuLinksListItem.TOGGLE, t.updatePanel),
			...
			(n = [{
					...
					value: function() {
							this.isOutlinePanel ? vu.on(bu.navData.REFRESH_VIEW, this.updatePanel) : this.isResourcesPanel ? vu.on(bu.resources.REFRESH_VIEW, this.updatePanel) : this.isGlossaryPanel && vu.on(bu.glossary.REFRESH_VIEW, this.updatePanel)
					}
			}, {
					key: "teardown",
					value: function() {
					...
					value: function() {
							...
							if (null != e)
									this.view.panel.height = Math.min(window.innerHeight - 120, e.clientHeight + 40),
									this.view.panel.update(),
									this.view.panel.updateChildren();
							else if (this.isOutlinePanel) {
									var t;
									t = Pu(document.body, "search-results-active") ? document.body.querySelector(".search-results-active .search-results ul") : document.body.querySelector("#outline-content ul"),
					...
					value: function() {
							...
							gu.deviceView.isPhone && wu.from(this.view.panel.el, .12, {
							...
							this.updatePanel(),
							this.view.panel.viewLogic.focusChild(),
							this.removeShowPanelListeners = yu.flow(Eu("keydown", (function(t) {
					...
					key: "handleKeyDown",
					value: function(e) {
							mu.isEscapeKey(e.which) && (this.hidePanel(),
							this.el.focus(),
							Su.setFocusRectOn(this.el))
					}
			}, {
					key: "hidePanel",
					value: function(e) {
							vu.trigger(bu.tabLink.HIDE_PANEL, this),
							!e && gu.deviceView.isPhone && this.view.panel.inEllipsis || (cu(hu(o.prototype), "hidePanel", this).call(this),
	...
	var Bu, Mu = DS.detection, Hu = DS.constants.refs.FRAME, Nu = Mu.deviceView.isPhone ? 290 : 302, Fu = DS, Wu = Fu.pubSub, Vu = Fu.events, Uu = !0, Ku = [], zu = !0;
	...
	!function(e) {
			var t, n = e.id, r = (G.def(n, (function(r) {
					...
					return t = n,
					{
							...
							w: function() {
									...
									return a.visible && (e -= a.w),
									s.visible && (e -= l.w),
									null != c && c.visible && (e -= c.w),
									u.visible && (e -= u.w),
									e - Ln
							},
							overflow: "visible",
			...
			function(n, r, i, o) {
					...
					u || (d["aria-controls"] = "".concat(i.name, "-panel"),
					d["aria-expanded"] = !1);
					var h = G.def(s, l, {
					...
					u || function(n, r, i, o) {
							...
							s.sidebar)
								...
								, f = (s.wrapper,
							s.topEllipsis,
							de.getColor(n, ".cs-topmenu-item.active .cs-panel", "border-top-color", ".cs-base"))
								...
								, m = G.def(a, Oo, {
									...
									x: function() {
											var e = 0;
											if (p.inEllipsis)
													return !g || Mu.deviceView.isPhone ? "left" === c.pos ? e = b.maxWidth - Nu + 8 : Mu.deviceView.isPhone || (e = (b.maxWidth - Nu) / 2 + 8) : "left" !== c.pos && (e = -2),
													e;
											var t = (e = r.x + (r.w - Nu) / 2) + Nu;
											return !p.inEllipsis && t > v.w && (e = v.w - Nu - 20),
											e = Math.max(g ? 20 : 0, e),
							...
							m.init(n),
							G.getNamespace(Hu)[e.id].append(m),
							r.panel = m;
							var w = Lc[o.name];
							null != w && (w.init(n),
							m.append(w))
			...
			x: function() {
					var e = G.getNamespace(DS.constants.refs.FRAME)
						...
						, i = e.topEllipsis
						, o = 0;
					return G.model.rtl ? (r.visible && (o += t.w),
					i.visible && (o += i.w,
					"right" === r.pos && (o = i.w))) : n.visible ? o = n.right() : r.visible && (o = t.w),
					o + ("right" === r.pos ? 0 : Ln)
			},
			methods: {
					tabWidths: function() {
					...
					phoneUpdateHook: function() {
							if (0 !== this.children.length || 0 !== Ku.length) {
									...
									this.children.forEach((function(e) {
											...
											null != e.panel && (e.panel.inEllipsis = !0,
											r.insertBefore(e.panel.el, r.firstChild),
											e.panel.update()),
											e.inEllipsis = !0,
			...
			updateHook: function() {
					if (DS.detection.deviceView.isPhone)
							this.phoneUpdateHook();
					else {
							var e = this.children;
							if (zu || 0 !== this.children.length || DS.presentation.isPreview() || this.setVisibility(Ku.length > 0 || this.children.some((function(e) {
									return e.visible
							}
							))),
							zu = !1,
							(0 !== e.length || 0 !== Ku.length) && null != this.nameSpace) {
									...
									Uu && Gu(e) > this.w)
											for (; Gu(e) > this.w; ) {
													...
													if (null != l && l.isTopLink) {
															if (null != l.el) {
																	...
																	null != l.panel && (l.panel.inEllipsis = !0,
																	s.insertBefore(l.panel.el, s.firstChild),
																	l.panel.update()),
																	l.inEllipsis = !0,
											...
											var c = Gu(e)
												, u = Ku[0];
											this.w > c + u.w && (Ku.shift(),
											this.el.appendChild(u.el),
											null != u.panel && (u.panel.inEllipsis = !1,
											u.panel.update(),
											this.el.appendChild(u.panel.el)),
											this.children.unshift(u),
											u.inEllipsis = !1)
									}
									0 === Ku.length && r.visible && r.setVisibility(!1),
									Uu = !1;
									var f = {
											toLeft: !0,
											startPos: n.w - xn,
									...
									"right" !== i.pos || G.model.rtl ? G.model.rtl && (f.toLeft = !1,
									f.startPos = 0,
									f.reverse = !1) : (f.toLeft = !1,
									f.startPos = 0,
									f.reverse = !0),
									this.flowChildren(f)
							}
	...
	var Yu = "bottomBar";
	G.def(Yu, (function(e) {
			var t, n = G.getNamespace(e), r = n.frame, i = n.topBar, o = n.navControls;
			return qu(t = {
					openPanels: {},
					tag: "section",
					attrs: {
			...
			qu(t, "methods", {
					panelToggled: function(e, t) {
							this.openPanels[e] = t,
							t ? this.el.style.zIndex = 11 : _.values(this.openPanels).every((function(e) {
									return !e
							}
	...
	function() {
			...
			(n = [{
					...
					value: function(e, t) {
							e !== this.currTimeline && (of.trigger(af.playbackControls.TIMELINE_CHANGED, e, t),
							null != this.currTimeline && (this.currTimeline.off(af.timeline.PLAYING, this.onPlaybackChanged),
					...
					value: function(e, t, n) {
							...
							this.view.nameSpace === n && (null != this.currSlide && this.currSlide.off(af.slide.CURRENT_TIMELINE, this.onTimelineChanged),
							this.currSlide = t,
	...
	function hf() {
			return hf = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function(e, t, n) {
					var r = function(e, t) {
	...
	function pf(e, t) {
			return pf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(e, t) {
					return e.__proto__ = t,
					e
			}
			,
	...
	function vf(e) {
			return vf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function(e) {
					return e.__proto__ || Object.getPrototypeOf(e)
			}
			,
			vf(e)
	...
	var mf = DS
		...
		, Bf = function(e) {
			...
			function o(e) {
					...
					n = bf(t),
					a = !0,
					(r = gf(r = "hasTooltip"))in n ? Object.defineProperty(n, r, {
							value: a,
							enumerable: !0,
							configurable: !0,
							writable: !0
			...
			(n = [{
					...
					value: function(e) {
							...
							setTimeout((function() {
									...
									t.el.contains(e) || "tooltip" === e.id || (t.isOpen = !1,
									_f(t.el, "open"),
									t.view.el.removeEventListener("mouseleave", t.onHide),
									Af("keydown", t.onKeydown),
									t.view.update())
							}
							), 200)
					}
					...
					value: function(e) {
							this.onShow(),
							this.onHoverIn(e),
							xf.setFocusRectOn(e.target)
					}
			}, {
					key: "onBlur",
					value: function(e) {
							null != e && this.isOpen && !this.el.contains(e.relatedTarget) && (this.onHoverOut(e),
							this.onHide(),
							hf(vf(o.prototype), "onBlur", this).call(this))
					}
			}, {
					key: "onKeydown",
					value: function(e) {
							...
							document.activeElement !== this.volumeRangeEl && (Cf.isDownishKey(t) || Cf.isPageDownKey(t) ? r(n - 1) : Cf.isUpishKey(t) || Cf.isPageUpKey(t) ? r(n + 1) : Cf.isEndKey(t) ? r(Rf) : Cf.isHomeKey(t) && (this.previousVolume = n,
							r(0)))
					}
			}, {
					key: "onScroll",
					...
					key: "dismissTooltip",
					value: function() {
							hf(vf(o.prototype), "dismissTooltip", this).call(this),
							this.onHide()
					}
			}, {
					key: "teardown",
	...
	function Uf(e, t) {
			for (var n = 0; n < t.length; n++) {
					...
					r.configurable = !0,
					"value"in r && (r.writable = !0),
					Object.defineProperty(e, Zf(r.key), r)
			}
	}
	function Kf(e, t) {
	...
	function Gf(e) {
			return Gf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function(e) {
					return e.__proto__ || Object.getPrototypeOf(e)
			}
			,
			Gf(e)
	...
	G.def(Hf, Mf, (function(e) {
			...
			return {
					...
					y: function() {
							return this.el.style.top = Ff(this.viewLogic.isOpen ? -58 : 17, !1),
							0
					},
					html: function() {
							return this.volumeStrength = this.volumeStrength || 10 * Wf.DEFAULT_VOLUME,
	...
	var qf = DS
		...
		, od = function(e) {
			...
			function o(e) {
					...
					n = Qf(t),
					a = !0,
					(r = Zf(r = "hasTooltip"))in n ? Object.defineProperty(n, r, {
							value: a,
							enumerable: !0,
							configurable: !0,
							writable: !0
			...
			(n = [{
					...
					value: function(e) {
							...
							this.toggle = Xf.isCaptionEnabled(),
							this.updateBtn()
					}
			}, {
	...
	function ud(e, t) {
			return ud = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(e, t) {
					return e.__proto__ = t,
					e
			}
			,
	...
	function fd(e) {
			...
			return function() {
					...
					if (t) {
							...
							n = r.apply(this, arguments);
					return function(e, t) {
							if (t && ("object" === sd(t) || "function" == typeof t))
									return t;
							if (void 0 !== t)
									throw new TypeError("Derived constructors may only return object or undefined");
							return dd(e)
	...
	var bd = DS
		...
		, Ed = function(e) {
			...
			(n = [{
					...
					key: "onTick",
					value: function(e) {
							null != this.circleProgress && this.circleProgress.setAttribute("d", DS.svgUtils.wheelPath(17, 17, 17, 0, 360 * e)),
							this.lastProgress = e
					}
			}, {
					key: "updateView",
					value: function() {
							this.view.updateHtml(),
							this.circleProgress = this.el.querySelector(".circle-progress path"),
	...
	function Td(e, t) {
			for (var n = 0; n < t.length; n++) {
					...
					r.configurable = !0,
					"value"in r && (r.writable = !0),
					Object.defineProperty(e, Rd(r.key), r)
			}
	}
	function _d(e, t) {
	...
	function jd(e) {
			...
			return function() {
					...
					if (t) {
							...
							n = r.apply(this, arguments);
					return function(e, t) {
							if (t && ("object" === Pd(t) || "function" == typeof t))
									return t;
							if (void 0 !== t)
									throw new TypeError("Derived constructors may only return object or undefined");
							return Dd(e)
	...
	var Bd = DS
		...
		, Zd = (Bd.stringTabler,
	function(e) {
			for (; e.startsWith("0") && !e.startsWith("0:"); )
					e = e.substring(1);
			return e
	}
	)
			...
			(n = [{
					...
					value: function() {
							if (this.isUserControlled) {
									...
									Hd.device.isMobile ? (e.addEventListener("touchstart", this.onMouseDown),
									this.seekEvent = "touchmove",
									this.endEvent = "touchend") : (e.addEventListener("mousedown", this.onMouseDown),
					...
					key: "onTimelineChanged",
					value: function(e, t) {
							null != this.currTimeline && (this.currTimeline.off(Qd.timeline.TICK, this.onTick),
							this.currTimeline.off(Qd.timeline.COMPLETE, this.checkSeekable)),
							this.currSlide = t,
							this.currTimeline = e,
					...
					key: "checkSeekable",
					value: function() {
							this.isSeekable() ? (Kd(this.el, "read-only"),
							this.progressBarEl.disabled = !1) : (Ud(this.el, "read-only"),
					...
					value: function(e) {
							...
							e.stopPropagation(),
							this.seeking = !0,
							!0 !== this.isUp && this.currTimeline.isPlaying() && (this.currTimeline.pause(!0),
							this.currTimeline.on(Qd.timeline.AFTER_SEEK_UPDATE, (function e() {
									t.currTimeline.play(),
									t.currTimeline.off(Qd.timeline.AFTER_SEEK_UPDATE, e)
							}
							)));
					...
					value: function(e, t) {
							...
							this.currTimeline.isPlaying() && (this.currTimeline.pause(),
							setTimeout((function() {
					...
					value: function(e) {
							var t = e.which;
							Fd.isActionKey(t) ? Gd.trigger(Qd.player.TOGGLE_PLAYBACK) : this.isSeekable() && (Fd.isDownishKey(t) ? this.seekBy(e, -100) : Fd.isPageDownKey(t) ? this.seekBy(e, -1e3) : Fd.isUpishKey(t) ? this.seekBy(e, 100) : Fd.isPageUpKey(t) && this.seekBy(e, 1e3))
					}
			}, {
					key: "getViewBox",
					value: function(e) {
							var t = this.view.getBox();
							return null != e && (t.x = "focusin" === e.type ? t.x + t.w / 2 : e.pageX,
							t.w = 2),
							t
					}
			}, {
	...
	function $d(e, t) {
			for (var n = 0; n < t.length; n++) {
					...
					"symbol" === Xd(o) ? o : String(o)), r)
			}
			var i, o
	}
	function Jd() {
			return Jd = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function(e, t, n) {
					var r = function(e, t) {
	...
	function eh(e, t) {
			return eh = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(e, t) {
					return e.__proto__ = t,
					e
			}
			,
	...
	function th(e) {
			...
			return function() {
					...
					if (t) {
							...
							n = r.apply(this, arguments);
					return function(e, t) {
							if (t && ("object" === Xd(t) || "function" == typeof t))
									return t;
							if (void 0 !== t)
									throw new TypeError("Derived constructors may only return object or undefined");
							return nh(e)
	...
	var ih = DS
		...
		, uh = function(e) {
			...
			function o(e) {
					...
					t.isUserControlled && (t.view.el.addEventListener("mouseenter", t.onStartProgressDetails),
			...
			n = [{
					key: "onTick",
					value: function(e) {
							Jd(rh(o.prototype), "onTick", this).call(this, e),
							this.progress = e
					}
			}, {
					...
					value: function() {
							this.progressPreviewEl.style.width = ch(this.previewWidth),
							this.prevProgressPreviewEl.style.width = ch(this.prevProgWidth)
					}
			}, {
		...
		, fh = uh
		, dh = (DS.detection.device.isMobile,
	"seek");
	function hh(e) {
	...
	function ph(e, t) {
			for (var n = 0; n < t.length; n++) {
					...
					r.configurable = !0,
					"value"in r && (r.writable = !0),
					Object.defineProperty(e, wh(r.key), r)
			}
	}
	function yh(e, t) {
	...
	function bh(e) {
			...
			return function() {
					...
					if (t) {
							...
							n = r.apply(this, arguments);
					return function(e, t) {
							if (t && ("object" === hh(t) || "function" == typeof t))
									return t;
							if (void 0 !== t)
									throw new TypeError("Derived constructors may only return object or undefined");
							return vh(e)
	...
	var Ph = function() {
		...
		, Th = {
			...
			volume: function(e, t) {
					var n = Math.min(1, e / 5)
						, r = Math.min(1, Math.max(0, e / 5 - .5));
					return '<svg class="cs-icon volume-icon '.concat(t ? "volume-icon-selected" : "", '" width="16px" height="14px" viewBox="0 -3 16 14" focusable="false">\n    <g transform="translate(0, -3)">\n      <rect x="0" y="4" width="3" height="6"></rect>\n      <polygon points="4 4 9 0 9 14 4 10"></polygon>\n      <g transform="translate(10, 0)">\n        <mask id="vol-mask" fill="white">\n          <rect id="path-1" x="0" y="0" width="8" height="14"></rect>\n        </mask>\n        <circle strokeWidth="1.5" style="opacity: ').concat(r, ';" mask="url(#vol-mask)" fill="none" cx="-1" cy="7" r="6.5"></circle>\n        <circle strokeWidth="1.5" style="opacity: ').concat(n, ';" mask="url(#vol-mask)" fill="none" cx="-1" cy="7" r="3.5"></circle>\n      </g>\n    </g>\n  </svg>')
			},
			captionsOn: function(e) {
					return '<svg class="cs-icon captions-icon" width="19px" height="16px" viewBox="0 0 19 16" focusable="false">\n            <path fill="#FFFFFF" stroke="none" d="M 19 2 Q 19 1.15 18.4 0.6 17.85 0 17 0 L 2 0 Q 1.15 0 0.6 0.6 0 1.15 0 2 L 0 12 Q 0 12.85 0.6 13.4 1.15 14 2 14 L 7.6 14 9.5 15.9 11.4 14 17 14 Q 17.85 14 18.4 13.4 19 12.85 19 12 L 19 2 M 15.7 4.2 L 15.25 4.85 Q 15.15 4.9 15.1 5 15 5.05 14.85 5.05 14.75 5.05 14.6 4.95 14.5 4.9 14.3 4.8 14.15 4.65 13.9 4.6 13.65 4.5 13.3 4.5 12.85 4.5 12.5 4.7 12.15 4.85 11.9 5.15 11.7 5.45 11.6 5.9 11.45 6.35 11.45 6.9 11.5 7.45 11.6 7.9 11.7 8.35 11.95 8.65 12.2 8.95 12.5 9.15 12.85 9.3 13.25 9.3 13.65 9.3 13.9 9.2 14.2 9.1 14.35 8.95 14.5 8.85 14.65 8.75 14.8 8.65 14.95 8.65 15.15 8.65 15.25 8.8 L 15.75 9.4 Q 15.45 9.75 15.15 10 14.8 10.2 14.45 10.35 14.05 10.5 13.7 10.55 13.3 10.6 12.95 10.6 12.25 10.6 11.65 10.35 11.1 10.1 10.65 9.65 10.2 9.15 9.95 8.45 9.7 7.75 9.7 6.9 9.7 6.1 9.95 5.4 10.15 4.75 10.6 4.25 11.05 3.75 11.7 3.5 12.35 3.2 13.2 3.2 14 3.2 14.6 3.45 15.2 3.7 15.7 4.2 M 5.85 4.7 Q 5.5 4.85 5.25 5.15 5.05 5.45 4.95 5.9 4.8 6.35 4.8 6.9 4.85 7.45 4.95 7.9 5.05 8.35 5.3 8.65 5.55 8.95 5.85 9.15 6.2 9.3 6.6 9.3 7 9.3 7.25 9.2 7.55 9.1 7.7 8.95 7.85 8.85 8 8.75 8.15 8.65 8.3 8.65 8.5 8.65 8.6 8.8 L 9.1 9.4 Q 8.8 9.75 8.5 10 8.15 10.2 7.8 10.35 7.4 10.5 7.05 10.55 6.65 10.6 6.3 10.6 5.6 10.6 5 10.35 4.45 10.1 4 9.65 3.55 9.15 3.3 8.45 3.05 7.75 3.05 6.9 3.05 6.1 3.3 5.4 3.5 4.75 3.95 4.25 4.4 3.75 5.05 3.5 5.7 3.2 6.55 3.2 7.35 3.2 7.95 3.45 8.55 3.7 9.05 4.2 L 8.6 4.85 Q 8.5 4.9 8.45 5 8.35 5.05 8.2 5.05 8.1 5.05 7.95 4.95 7.85 4.9 7.65 4.8 7.5 4.65 7.25 4.6 7 4.5 6.65 4.5 6.2 4.5 5.85 4.7 Z"/>\n          </svg>'
			},
	...
	function Rh(e) {
			...
			return function() {
					...
					if (t) {
							...
							n = r.apply(this, arguments);
					return function(e, t) {
							if (t && ("object" === Dh(t) || "function" == typeof t))
									return t;
							if (void 0 !== t)
									throw new TypeError("Derived constructors may only return object or undefined");
							return Bh(e)
	...
	function Mh(e) {
			return Mh = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function(e) {
					return e.__proto__ || Object.getPrototypeOf(e)
			}
			,
			Mh(e)
	...
	var Nh = DS
		...
		, zh = function(e) {
			...
			function o(e) {
					...
					n = Bh(t),
					a = !0,
					(r = Hh(r = "hasTooltip"))in n ? Object.defineProperty(n, r, {
							value: a,
							enumerable: !0,
							configurable: !0,
							writable: !0
	...
	function Jh(e, t) {
			for (var n = 0; n < t.length; n++) {
					...
					r.configurable = !0,
					"value"in r && (r.writable = !0),
					Object.defineProperty(e, ip(r.key), r)
			}
	}
	function ep(e, t) {
	...
	function rp(e) {
			return rp = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function(e) {
					return e.__proto__ || Object.getPrototypeOf(e)
			}
			,
			rp(e)
	...
	function(e) {
			...
			function o(e) {
					...
					n = np(t),
					a = !0,
					(r = ip(r = "hasTooltip"))in n ? Object.defineProperty(n, r, {
							value: a,
							enumerable: !0,
							configurable: !0,
							writable: !0
			...
			(n = [{
					...
					value: function() {
							this.view.toggle = this.isFullScreen(),
							this.view.updateHtml()
					}
			}, {
					key: "onClickToggle",
	...
	G.def(up, cp, (function(e) {
			...
			return {
					...
					html: function() {
							...
							return this.el.setAttribute("aria-label", t.getString(e)),
							this.toggle ? jh("exitFullScreen")() : jh("enterFullScreen")()
					},
					methods: {
							updateDomStrings: function() {
									var e = this.toggle ? "acc_exit_fullscreen" : "acc_enter_fullscreen";
	...
	function yp(e, t) {
			for (var n = 0; n < t.length; n++) {
					...
					"symbol" === pp(o) ? o : String(o)), r)
			}
			var i, o
	}
	function bp() {
			return bp = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function(e, t, n) {
					var r = function(e, t) {
	...
	function gp(e) {
			...
			return function() {
					...
					if (t) {
							...
							n = r.apply(this, arguments);
					return function(e, t) {
							if (t && ("object" === pp(t) || "function" == typeof t))
									return t;
							if (void 0 !== t)
									throw new TypeError("Derived constructors may only return object or undefined");
							return mp(e)
	...
	var Sp = DS
		...
		, Dp = function(e) {
			...
			function o(e) {
					...
					return t.topEllipsisPanel = n.topEllipsisPanel,
			...
			(n = [{
					...
					value: function(e) {
							...
							null == t ? null == DS.dom.getParentWithClass(e.target, "panel") && bp(wp(o.prototype), "onFocus", this).call(this, e) : DS.focusManager.setFocusRectOn(t)
					}
			}, {
					key: "onLayoutReady",
					value: function(e) {
					...
					key: "onCheckShouldHide",
					value: function(e) {
							this.hideOnNextTouch && (_p(e.target, "top-ellipsis-panel") ? Cp.deviceView.isPhone && document.body.classList.contains("nested-panel-shown") && !_p(e.target, "panel") && this.hidePanel() : this.hidePanel())
					}
			}, {
					key: "updateAnimation",
					value: function() {
					...
					value: function() {
							...
							Cp.deviceView.isDesktop && (DS.flagManager.multiLangSupport || DS.flagManager.aiCourseTranslation ? this.arrowEl.style.visibility = "visible" : this.arrowEl.style.display = "block"),
					...
					value: function() {
							...
							this.updateAnimation(),
							null != this.currentPanelLink && (this.currentPanelLink.hidePanel(!0),
	...
	G.def(Ip, Ap, (function(e) {
			var t = G.getNamespace(e)
				...
				, r = t.sidebar
				, i = (G.model.rtl,
			de.getColor(e, ".cs-topmenu-item.active .cs-panel", "border-top-color", ".cs-base"))
			...
			return {
					...
					x: function() {
							var e = G.model.rtl
								, t = 0;
							return Bp ? "right" === r.pos ? 0 : window.innerWidth - 58 : (t = e ? n.x - 58 + xn : "right" === r.pos ? n.x + n.tabWidths() : n.right(),
							t)
					},
					w: 58,
					visible: !1,
	...
	function zp(e, t) {
			for (var n = 0; n < t.length; n++) {
					...
					r.configurable = !0,
					"value"in r && (r.writable = !0),
					Object.defineProperty(e, Yp(r.key), r)
			}
	}
	function Qp(e, t) {
	...
	function Gp(e) {
			...
			return function() {
					...
					if (t) {
							...
							n = r.apply(this, arguments);
					return function(e, t) {
							if (t && ("object" === Kp(t) || "function" == typeof t))
									return t;
							if (void 0 !== t)
									throw new TypeError("Derived constructors may only return object or undefined");
							return Zp(e)
	...
	var Xp = DS.utils
		, $p = function(e) {
					...
					a = function() {
							...
							if (null != e) {
									if (G.getNamespace(t.view.nameSpace).slide.el.contains(e)) {
											...
											null != n ? (null == t.origParent && (t.origParent = t.el.parentElement),
											n.appendChild(t.el)) : DS.flagManager.dropInVideo && (clearTimeout(t.findHost),
											t.findHost = window.setTimeout(t.reparent, 30))
									}
							} else
									null != t.origParent && (t.origParent.appendChild(t.el),
									t.origParent = null)
					}
					,
					(r = Yp(r = "reparent"))in n ? Object.defineProperty(n, r, {
							value: a,
							enumerable: !0,
							configurable: !0,
							writable: !0
			...
			(n = [{
					key: "handleFullScreenChange",
					value: function() {
							DS.flagManager.dropInVideo ? (clearTimeout(this.reparentTimeout),
							this.reparentTimeout = window.setTimeout(this.reparent, 200)) : window.requestAnimationFrame(this.reparent)
					}
			}]) && zp(t.prototype, n),
			r && zp(t, r),
			Object.defineProperty(t, "prototype", {
	...
	function ay() {
			return ay = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function(e, t, n) {
					var r = function(e, t) {
	...
	function sy(e) {
			...
			return function() {
					...
					if (t) {
							...
							n = r.apply(this, arguments);
					return function(e, t) {
							if (t && ("object" === iy(t) || "function" == typeof t))
									return t;
							if (void 0 !== t)
									throw new TypeError("Derived constructors may only return object or undefined");
							return cy(e)
	...
	var hy = DS
		...
		, xy = function(e) {
			...
			function o(e) {
					...
					null != t.shortcutsSwitchEl && (t.onClickEl(t.shortcutsSwitchEl, t.toggleShortcuts),
					DS.pubSub.on(wy.player.ENABLE_KEYBOARD_SHORTCUTS, t.onKeyboardShortcutsChanged)),
					null != t.captionsButtonEl && (t.onClickEl(t.captionsButtonEl, t.toggleCaptions),
					ky.on(wy.captions.ENABLED, t.onCaptionsEnabled)),
					null != t.resetButtonEl && t.onClickEl(t.resetButtonEl, t.resetTimeline),
					null != t.acctextSwitchEl && (t.onClickEl(t.acctextSwitchEl, t.toggleAccessibleText),
					vy.on(wy.player.ACCESSIBLE_TEXT_CHANGED, t.onAccessibleTextChanged)),
					null != t.zoomSwitchEl && (t.onClickEl(t.zoomSwitchEl, t.toggleZoomMode),
					ky.on(wy.window.ZOOM_MODE_CHANGED, t.onZoomModeChanged)),
					t.handleFullScreenChange = t.handleFullScreenChange.bind(cy(t)),
					null != t.fullScreenToggleButtonEl && (t.onClickEl(t.fullScreenToggleButtonEl, t.toggleFullScreen),
					t.removeFullScreenListener = Ey.addChangeListener(t.handleFullScreenChange)),
					null != t.backgroundAudioSwitchEl && (t.onClickEl(t.backgroundAudioSwitchEl, t.onToggleBackgroundAudio),
					ky.on(wy.backgroundAudio.HAS_TOGGLED, t.toggleBackgroundAudio)),
					t
			}
			return t = o,
			(n = [{
					...
					key: "handleKeyDown",
					value: function(e) {
							Oy.isEscapeKey(e.which) && (this.hidePanel(),
							this.settingsBtnEl.focus(),
							Sy.setFocusRectOn(this.settingsBtnEl))
					}
			}, {
					key: "onBlur",
					value: function(e) {
							null != e && this.isOpen && !this.el.contains(e.relatedTarget) && (this.hidePanel(),
							ay(uy(o.prototype), "onBlur", this).call(this))
					}
			}, {
					key: "updateToggle",
					value: function(e, t) {
							t ? (yy(e, "toggle-on"),
							by(e, "toggle-off")) : (yy(e, "toggle-off"),
							by(e, "toggle-on")),
					...
					value: function() {
							...
							this.updateToggle(this.acctextSwitchEl, this.accTextOn),
							vy.onToggleAccessibleText(this.accTextOn)
					}
			}, {
					...
					key: "toggleZoomMode",
					value: function() {
							gy.enableZoomMode(!gy.zoomMode),
							this.updateToggle(this.zoomSwitchEl, gy.zoomMode),
							Sy.setFocusRectOn(this.zoomSwitchEl.querySelector("button"))
					}
			}, {
					key: "toggleShortcuts",
					value: function() {
							my.enableShortcuts(!my.enabled),
							this.updateToggle(this.shortcutsSwitchEl, my.enabled)
					}
			}, {
					key: "toggleCaptions",
					value: function() {
							G.getNamespace("_frame").captions.viewLogic.toggleCaptions(),
	...
	function By(e, t) {
			for (var n = 0; n < t.length; n++) {
					...
					r.configurable = !0,
					"value"in r && (r.writable = !0),
					Object.defineProperty(e, Uy(r.key), r)
			}
	}
	function My() {
			return My = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function(e, t, n) {
					var r = function(e, t) {
	...
	function Hy(e, t) {
			return Hy = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(e, t) {
					return e.__proto__ = t,
					e
			}
			,
	...
	function Ny(e) {
			...
			return function() {
					...
					if (t) {
							...
							n = r.apply(this, arguments);
					return function(e, t) {
							if (t && ("object" === Ay(t) || "function" == typeof t))
									return t;
							if (void 0 !== t)
									throw new TypeError("Derived constructors may only return object or undefined");
							return Fy(e)
	...
	function Wy(e) {
			return Wy = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function(e) {
					return e.__proto__ || Object.getPrototypeOf(e)
			}
			,
			Wy(e)
	...
	function Vy(e, t, n) {
			return (t = Uy(t))in e ? Object.defineProperty(e, t, {
					value: n,
					enumerable: !0,
					configurable: !0,
					writable: !0
	...
	G.def(Dy, Ly, (function(e) {
			var t = G.model
				, n = (G.model.rtl,
			de.getColor(e, ".cs-topmenu-item.active .cs-panel", "background-color"))
			...
			return {
					...
					methods: {
							getControlConfigs: function() {
									...
									}].concat(Py(DS.frameModel.hasModernText ? [{
											name: "acctext",
									...
									}], Py(null != DS.courseAudio && DS.courseAudio.hasAudio() ? [{
		...
		, $y = function(e) {
			...
			function o(e) {
					...
					Iy(t.el.querySelectorAll(".menu-choice")).forEach((function(e) {
							e.classList.contains("selected") && (t.currentSpeed = e.dataset.speed,
							t.currentIndex = e.dataset.index,
							t.selectedEl = e),
			...
			(n = [{
					...
					value: function(e) {
							...
							var t = e.dataset
								, n = t.speed
								, r = t.index;
							this.currentSpeed = parseFloat(n),
							this.currentIndex = parseInt(r),
							Zy.setPlaybackSpeed(this.currentSpeed)
					}
			}, {
					key: "togglePanel",
					value: function() {
					...
					value: function(e) {
							...
							if (Yy.isDownishKey(e.which))
									t++;
							else if (Yy.isUpishKey(e.which))
									t--;
							else if (Yy.isHomeKey(e.which))
									t = 0;
							else if (Yy.isEndKey(e.which))
									t = 7;
									...
									Yy.isEscapeKey(e.which) && (this.hidePanel(),
									this.toggleBtnEl.focus(),
									e.preventDefault());
							t >= 8 && (t = 0),
							t < 0 && (t = 7),
							t !== this.currentFocusIndex && (this.currentFocusIndex = t,
							e.preventDefault(),
							this.el.querySelector('[data-index="'.concat(t, '"]')).focus())
					}
			}, {
					key: "showPanel",
					value: function() {
					...
					value: function(e) {
							null != e && this.isOpen && !this.el.contains(e.relatedTarget) && (this.hidePanel(),
							My(Wy(o.prototype), "onBlur", this).call(this))
					}
			}, {
					key: "onFocus",
					value: function(e) {
							...
							getSpeedOptions: function() {
									...
									return [{
											...
											var n = e.label
												...
												, a = ""
												, l = "";
											return null != o && (a = 'data-ref="label'.concat(o, '"'),
											l = 'data-ref="aria'.concat(o, '"')),
	...
	function ab(e, t) {
			for (var n = 0; n < t.length; n++) {
					...
					r.configurable = !0,
					"value"in r && (r.writable = !0),
					Object.defineProperty(e, hb(r.key), r)
			}
	}
	function lb() {
			return lb = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function(e, t, n) {
					var r = function(e, t) {
	...
	function cb(e) {
			...
			return function() {
					...
					if (t) {
							...
							n = r.apply(this, arguments);
					return function(e, t) {
							if (t && ("object" === rb(t) || "function" == typeof t))
									return t;
							if (void 0 !== t)
									throw new TypeError("Derived constructors may only return object or undefined");
							return ub(e)
	...
	G.def(nb, (function(e) {
			var t = G.getNamespace(e).slide
				, n = function() {
					return "".concat(t.x, "px ").concat(t.w, "px ").concat(window.innerWidth - t.x - t.w, "px")
			}
				, r = function() {
					return "".concat(t.y, "px ").concat(t.h, "px ").concat(window.innerHeight - t.y - t.h, "px")
			};
			return {
					attrs: {
							id: nb,
					...
					updateHook: function() {
							var e = this;
							window.requestAnimationFrame((function() {
									e.el.style["grid-template-columns"] = n(),
									e.el.style["grid-template-rows"] = r()
							}
							))
					},
					methods: {
	...
	pb.focusManager)
		...
		, kb = function(e) {
			...
			function o(e) {
					...
					return t.itemCount = n.length,
					n.forEach((function(e) {
							e.classList.contains("selected") && (t.currentLangCode = e.dataset.langCode,
							t.currentIndex = e.dataset.index,
							t.selectedEl = e),
							t.onClickEl(e, (function() {
									return t.choiceClicked(e)
			...
			(n = [{
					...
					value: function(e) {
							...
							var t = e.dataset
								, n = t.langCode
								, r = t.index;
							this.currentLangCode = n,
							this.currentIndex = parseInt(r),
							Sb.setCurrentLanguage(this.currentLangCode)
					}
			}, {
					key: "togglePanel",
					value: function() {
					...
					value: function(e) {
							...
							if (mb.isDownishKey(e.which) ? t++ : mb.isUpishKey(e.which) ? t-- : mb.isHomeKey(e.which) ? t = 0 : mb.isEndKey(e.which) && (t = this.itemCount - 1),
							t >= this.itemCount && (t = 0),
							t < 0 && (t = this.itemCount - 1),
							t !== this.currentIndex) {
									e.preventDefault();
									var n = this.el.querySelector('[data-index="'.concat(t, '"]'));
									this.updateLanguage(n),
									n.focus()
							}
					}
			}, {
					...
					value: function(e) {
							null != e && this.isOpen && !this.el.contains(e.relatedTarget) && (this.hidePanel(),
							lb(fb(o.prototype), "onBlur", this).call(this))
					}
			}, {
					key: "onFocus",
					value: function(e) {
	...
	jb.captionsManager);
	function Ib(e) {
			return Ib = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
					return typeof e
			}
			: function(e) {
					return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e
	...
	G.def(Vb, Fb, (function(e) {
			...
			return {
					...
					overflow: "visible",
					dimScale: function() {
							var e = .8 * (window.innerWidth - t.getDockedWidth())
					...
					w: function() {
							...
							return this.scrollW = t,
							Wb.zoomMode ? Math.min(n, e) + t : e
					},
					h: function() {
	...
	G.def(zb, Cn, (function(e) {
			var t, n = G.getNamespace(e), r = n.lightBoxBottom, i = n.lightBoxWrapper;
			return Kb(t = {
					attrs: {
			...
			Kb(t, "bgColor", "white"),
			Kb(t, "add", !0),
			Kb(t, "html", '<div id="slide-label-lightbox" data-ref="label" aria-live="polite"></div><main data-ref="container" class="slide-container" tabindex="-1"></main>'),
			Kb(t, "childViews", ["captionContainer"]),
			Kb(t, "updateHook", (function() {
					var e = this;
					if (Gb.zoomMode) {
							null == this.scrollbar && (this.scrollbar = new Zb(this.el,"lightbox-slide"),
							this.hscrollbar = new Zb(this.el,"lightbox-slide",!0)),
	...
	function Jb(e) {
			...
			return function() {
					...
					if (t) {
							...
							n = r.apply(this, arguments);
					return function(e, t) {
							if (t && ("object" === Yb(t) || "function" == typeof t))
									return t;
							if (void 0 !== t)
									throw new TypeError("Derived constructors may only return object or undefined");
							return function(e) {
	...
	function iv(e, t) {
			for (var n = 0; n < t.length; n++) {
					...
					"symbol" === rv(o) ? o : String(o)), r)
			}
			var i, o
	}
	function ov(e, t) {
			return ov = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(e, t) {
					return e.__proto__ = t,
					e
			}
			,
	...
	function lv(e) {
			return lv = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function(e) {
					return e.__proto__ || Object.getPrototypeOf(e)
			}
			,
			lv(e)
	...
	G.def(pv, (function(e) {
			var t = G.getNamespace(e)
				...
				, r = t.lightBoxBottom
				, i = function() {
					return "".concat(n.x, "px ").concat(n.w, "px ").concat(window.innerWidth - n.x - n.w, "px")
			}
				, o = function() {
					return "".concat(n.y, "px ").concat(n.h - r.h, "px ").concat(window.innerHeight - n.y - n.h + r.h, "px")
			};
			return {
					attrs: {
							id: pv,
					...
					updateHook: function() {
							var e = this;
							window.requestAnimationFrame((function() {
									e.el.style["grid-template-columns"] = i(),
									e.el.style["grid-template-rows"] = o()
							}
							))
					},
					methods: {
	...
	function Pv(e, t) {
			for (var n = 0; n < t.length; n++) {
					...
					"symbol" === Lv(o) ? o : String(o)), r)
			}
			var i, o
	}
	function Tv() {
			return Tv = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function(e, t, n) {
					var r = function(e, t) {
	...
	function _v(e, t) {
			return _v = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(e, t) {
					return e.__proto__ = t,
					e
			}
			,
	...
	function jv(e) {
			...
			return function() {
					...
					if (t) {
							...
							n = r.apply(this, arguments);
					return function(e, t) {
							if (t && ("object" === Lv(t) || "function" == typeof t))
									return t;
							if (void 0 !== t)
									throw new TypeError("Derived constructors may only return object or undefined");
							return Dv(e)
	...
	function Av(e) {
			return Av = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function(e) {
					return e.__proto__ || Object.getPrototypeOf(e)
			}
			,
			Av(e)
	...
	var Gv = function(e) {
			...
			function o(e) {
					...
					null != t.keyboardShortcutsSwitchEl && (t.onClickEl(t.keyboardShortcutsSwitchEl, t.toggleKeyboardShortcuts),
					Nv.on(Vv, t.onKeyboardShortcutsChanged)),
					t
			}
			return t = o,
			(n = [{
					...
					key: "onKeyboardShortcutsChanged",
					value: function(e) {
							e ? (this.keyboardShortcutsSwitchEl.classList.add("toggle-on"),
							this.keyboardShortcutsSwitchEl.classList.remove("toggle-off"),
							this.shortcutsTableEl.classList.remove("disabled")) : (this.keyboardShortcutsSwitchEl.classList.add("toggle-off"),
	...
	G.def(Iv, Gv, (function() {
			...
			return {
					...
					z: 1,
					html: function() {
							var t = DS.detection.theme.isUnified ? [zv.refs.FRAME, ".cs-brandhighlight-bg", "background-color", ".cs-base.cs-custom-theme"] : [zv.refs.FRAME, ".cs-duration stop:last-child", "stop-color", void 0, ".cs-duration stop"]
								...
								, o = Mv.getShortcutList().map((function(t) {
									var n = t.name
										, r = t.keyInfo;
									return '<tr class="'.concat("?" === r.key ? "" : "disableable", '"><td class="action">').concat(n, '</td><td class="key">').concat(function(e, t) {
											return (e.ctrl ? t.getString("ctrl_key") + "+" : "") + (e.alt ? t.getString("alt_key") + "+" : "") + (e.shift ? t.getString("shift_key") + "+" : "") + (e.keyName || e.key).toUpperCase()
									}(r, e), "</td></tr>")
							}
							)).join("")
	...
	!function(e, t) {
			...
			function(e) {
					...
					if (window.globalProvideData = function(e, n) {
							"frame" === e && (null != (ve = JSON.parse(n)).localization && DS.flagManager.multiLangSupport ? (DS.localizationManager.registerFrameLanguageData(ve.localization),
					...
					window.globals.useJson) {
							...
							return r.overrideMimeType("application/json"),
			...
			var t, n, r = e.topTabsLeft, i = e.topTabsRight, o = e.sidebarOpts, a = o.timeEnabled, l = o.logoEnabled, s = o.html5_logo_url, c = e.frame.controlOptions.controls, u = c.closed_captions, f = c.settings, d = function() {
					return e.frame.chromeless || Db.env.hideFrame
			}, h = function() {
					return G.tree(_b, [{
							wrapper: [d() ? "slide" : {
									frame: ["frameBlocker", d() ? null : "sidebarOverlay", "slide", !d() && e.frame.skip_nav_enabled ? "skipnav" : null, {
											bottomBar: [{
													playbackControls: ["playPause", "seek", "reset"]
											}, {
													miscControls: ["volume"].concat(Pb(u ? ["captions"] : []), ["playbackSpeed"], Pb(DS.flagManager.multiLangSupport && DS.localizationManager.getLanguages().length > 1 ? ["languagePicker"] : []), Pb(f ? ["settings"] : []))
											}, {
			...
			Array.from(t).forEach((function(e) {
					...
					if ("outline-panel" != t) {
							...
							null != i && new nt(i,"outline",!1,n),
							null != o && new nt(o,"search",!1,n)
					}
			}
			));
			var y = function(e) {
				...
				, v = function(t, n) {
					if (n === _b) {
							var r = function(e, t) {
									...
									return n && (n = ot(e.sidebarTabs, t)),
									n || e.sidebarOpts.logoEnabled && DS.detection.theme.isClassic
							}(e, t)
			...
			var g, m = function(e) {
					...
					null != l && (a ? "toggle_window_control_visible" === t ? (l.setVisibility(!l.visible),
					l.childVisibilityChanged()) : l.setEnabled(!l.enabled, o) : "set_window_control_visible" === t ? (l.setVisibility(r),
					l.childVisibilityChanged()) : l.setEnabled(i, o))
			};
			if (DS.pubSub.on(DS.events.navcontrols.CHANGED, m),
			!window.globals.HAS_SLIDE && !Db.theme.isClassic) {
					...
					var w = function() {
						...
						, S = function(e) {
							...
							null != e) {
									...
									n > 50 ? (t.style.top = "unset",
									t.style.bottom = "".concat(100 - n, "%")) : (t.style.top = e.placement,
									t.style.bottom = "unset");
									var r = t.querySelector("p");
									r.style.backgroundColor = e.backgroundColor,
									r.style.color = e.color,
									DS.frameModel.frame.controlOptions.ccOptions = e
							}
					}
						, k = function(e) {
							w(),
							g = e,
							document.querySelector(".caption-container").style.display = e ? "block" : "none"
					};
					DS.pubSub.on(DS.events.ccOptions.CHANGED, S),
					DS.pubSub.on(DS.events.captions.ENABLE, k),
					DS.pubSub.on(DS.events.captions.ENABLED, k)
			}
			var O = function() {
					G.update(p);
			...
			DS.pubSub.on(DS.events.utilityWindow.DOCKED, (function(t, n) {
					var r = n.dockedState
						, i = n.dockedWidth;
					e.setDocked(t, r, i),
					DS.pubSub.trigger(DS.events.frame.SCALE);
			...
			var E = function() {
					p = h(),
					DS.pubSub.trigger(DS.events.controlOptions.RESET)
			};
			return DS.pubSub.on(DS.events.frameModel.CHROMELESS_CHANGED, E),
			{
					all: O,
					resize: O,
					rerender: function() {
							...
							window.globals.HAS_SLIDE || window.requestAnimationFrame((function() {
	...
	Jv(Yv, dv, (function(e) {
			var t = G.tree(dv, ["lightBoxBlocker", "visibleOverlay", {
					lightBoxWrapper: ["lightBoxSlide", "lightBox"]
			}, "lightBoxClose"])
				, n = G.getNamespace(dv);
			return n.slide = n.lightBoxSlide,
	...
	Jv(Yv, yv, (function(e) {
			var t = G.tree(yv, ["lightBoxControlsBlocker", "visibleOverlay", {
			...
			var r = function(e, n) {
					if (n === yv) {
							...
							G.resetStates(yv),
							G.updateVisibility(r, yv),
							G.update(t)
					}
			};
			return DS.pubSub.on(DS.events.frameModel.LAYOUT_CHANGED, r),
	...
	Jv(Yv, kv, (function(e) {
			var t = G.tree(kv, ["overlay", {
					messageWindowWrapper: ["messageWindowSlide"]
			}])
				, n = G.getNamespace(kv);
			return n.slide = n.messageWindowSlide,
			n.wrapper = n.messageWindowWrapper,
			{
					...
					resize: function() {
							n.isAttached && (n.overlay.update(),
							n.messageWindowWrapper.update())
					}
			}
	}
	)),
	Jv(Yv, Xv, (function(e) {
			var t = G.tree(Xv, ["visibleOverlay", {
					shortcutWrapper: ["shortcutSlide"]
			}, "shortcutClose"])
				, n = G.getNamespace(Xv);
			return n.slide = n.shortcutSlide,
